...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Seed Sample Category & Brand ONLY if empty
        ...
        if (\Illuminate\Support\Facades\DB::table('brands')->count() === 0) {
        ...
        // Seed Sample Products ONLY if products table is completely empty

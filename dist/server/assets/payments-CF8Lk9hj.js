...
import { t as clearBootstrapCache } from "./bootstrap-DBQz0zB2.js";
import { a as methodLabel, n as cfgBool, r as cfgString, t as MANUAL_METHODS } from "./payment-methods-riM5eEMo.js";
import { n as listDepositGateways, t as listActiveGateways } from "./gateways.functions-BdDD0ymF.js";
import { n as paymentLogo, t as PaymentLogo } from "./payment-brand-ChxX82bm.js";
import { t as AppModal } from "./AppModal-C8qUvQNk.js";
import { a as field, i as Switch, n as Label, r as StatusDot, t as GatewayGrid } from "./gateway-grid-AQ9LB1YZ.js";
...
function ResellerPaymentsPage() {
	...
	const [globalManual, setGlobalManual] = useState([]);
	const [gateways, setGateways] = useState([]);
	const [platformGateways, setPlatformGateways] = useState([]);
	const [myGw, setMyGw] = useState([]);
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("button", {
				...
				children: [/* @__PURE__ */ jsx(Wallet, { className: "h-3.5 w-3.5" }), " Manual"]
		...
		/* @__PURE__ */ jsx("div", {
			...
			children: resellerId ? /* @__PURE__ */ jsx(GatewayGrid, {
				resellerId,
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("h2", {
					...
					children: [
						/* @__PURE__ */ jsx(Globe2, { className: "h-4 w-4 text-primary" }),
						" Global methods",
						/* @__PURE__ */ jsx("span", {
				...
				}), globalManual.length + platformGateways.length === 0 ? /* @__PURE__ */ jsx("div", {
					className: "rounded-xl border border-dashed p-8 text-center text-xs text-muted-foreground",
				...
				children: [/* @__PURE__ */ jsxs("h2", {
					...
					children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5" }), " Add method"]
				})]
			}), myMethods.length === 0 ? /* @__PURE__ */ jsxs("div", {
				className: "rounded-xl border border-dashed p-10 text-center",
				children: [
					/* @__PURE__ */ jsx(Wallet, { className: "mx-auto mb-2 h-6 w-6 text-muted-foreground" }),
					/* @__PURE__ */ jsx("p", {
				...
				className: "grid gap-3 md:grid-cols-2 xl:grid-cols-3",
				children: myMethods.map((row) => /* @__PURE__ */ jsxs("div", {
					className: "surface-card flex flex-col p-4",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-start gap-3",
							children: [
								/* @__PURE__ */ jsx(Logo, { method: row.method }),
								/* @__PURE__ */ jsxs("div", {
									className: "min-w-0 flex-1",
									children: [/* @__PURE__ */ jsx("div", {
		...
		draft && resellerId && /* @__PURE__ */ jsx(MyMethodModal, {
			draft,
			resellerId,
...
function Logo({ method }) {
	return /* @__PURE__ */ jsx("span", {
		...
		children: paymentLogo(method) ? /* @__PURE__ */ jsx(PaymentLogo, {
			method,
			width: 96,
			height: 44,
			fit: "cover",
...
function Head({ method, label, tag, icon }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "flex items-start gap-3",
		children: [/* @__PURE__ */ jsx(Logo, { method }), /* @__PURE__ */ jsxs("div", {
			className: "min-w-0 flex-1",
			children: [/* @__PURE__ */ jsx("div", {
				className: "truncate text-sm font-semibold",
				children: label
			...
			children: [
				/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsx("select", {
						...
						className: field,
						children: MANUAL_METHODS.map((m) => /* @__PURE__ */ jsx("option", {
							value: m.value,
							children: m.label
						}, m.value))
					}),
				...
				/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "Account / number" }), /* @__PURE__ */ jsx("input", {
					value: cfgString(row.config, "account"),
					onChange: (e) => setConfig("account", e.target.value),
					className: field,
					placeholder: "01700000000"
				})] }),
				/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "Account type" }), /* @__PURE__ */ jsx("input", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Label, { children: "Payment instructions" }), /* @__PURE__ */ jsx("textarea", {
						rows: 4,

...
import { r as agentCommission } from "./agents-uzlhu9BH.js";
import { a as OrderFilterBar, i as DEFAULT_ORDER_FILTERS, l as resolveDateRange, s as applyOrderFilters } from "./order-filters-C0seZ87w.js";
import { i as usePaginated, r as Pagination } from "./data-list-Cd6RJIu_.js";
import { i as SortTh, n as ReportCard, r as ReportTabs, s as toneOf } from "./report-blocks-CRm2raRg.js";
...
import { AlertTriangle, ArrowRight, Ban, Boxes, CircleDot, ClipboardCheck, Download, Factory, Loader2, Package, PackageCheck, PackageSearch, Percent, Receipt, Send, Sparkles, Target, TrendingUp, Truck, Undo2, Users, Wallet } from "lucide-react";
...
function BusinessReportPage() {
	...
	const [supSort, setSupSort] = useState({
		key: "buyCost",
		dir: "desc"
	});
	const [couSort, setCouSort] = useState({
		key: "parcels",
		dir: "desc"
	});
	const [agtSort, setAgtSort] = useState({
		key: "sales",
		dir: "desc"
	});
	useEffect(() => {
	...
	const potential = useMemo(() => buildPotential(filtered, filteredItems, productMap), [
		filtered,
		filteredItems,
		productMap
	]);
	...
	const productRows = useMemo(() => sortRows(buildProductRows(scoped, scopedItems, productMap), prodSort.key, prodSort.dir), [
		scoped,
		scopedItems,
		productMap,
		prodSort
	]);
	const resellerRows = useMemo(() => sortRows(buildResellerRows(scoped, scopedItems, productMap, shipments), resSort.key, resSort.dir), [
		scoped,
		scopedItems,
		productMap,
		shipments,
	...
	const courierRows = useMemo(() => sortRows(buildCourierRows(scoped, scopedItems, productMap, shipments), couSort.key, couSort.dir), [
		scoped,
		scopedItems,
		productMap,
		shipments,
	...
	const supplierRows = useMemo(() => sortRows(buildSupplierRows(scoped, scopedItems, productMap, supplierMap), supSort.key, supSort.dir), [
		scoped,
		scopedItems,
		productMap,
		supplierMap,
	...
	const trend = useMemo(() => buildDailyTrend(scoped, scopedItems, productMap, shipments), [
		scoped,
		scopedItems,
		productMap,
		shipments
	...
	const pnl = useMemo(() => buildPnL(scoped, scopedItems, productMap, scopedExpenses, agentCommissionTotal, shipments), [
		scoped,
		scopedItems,
		productMap,
		scopedExpenses,
	...
	const avatarByReseller = useMemo(() => new Map(resellers.map((r) => [r.id, r.avatar_url ?? null])), [resellers]);
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsx(PageHeader, {
			...
			actions: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsx(Receipt, { className: "mr-1.5 h-3.5 w-3.5" }), " Expenses"]
		...
		pnl.runningOrders > 0 && /* @__PURE__ */ jsxs("div", {
		...
		tab === "overview" && /* @__PURE__ */ jsxs("div", {
			...
			children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: /* @__PURE__ */ jsx(Percent, { className: "h-4 w-4" })
								}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsx(ReportCard, {
					...
					children: trend.length === 0 ? /* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx("span", { children: "Net profit kept" }), /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(ReportCard, {
								...
								right: /* @__PURE__ */ jsxs("button", {
									...
									children: ["All products ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3" })]
								}),
								children: /* @__PURE__ */ jsx("div", {
									className: "p-4",
									children: /* @__PURE__ */ jsx(TopList, {
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(ReportCard, {
								...
								right: /* @__PURE__ */ jsxs("button", {
									...
									className: "inline-flex items-center gap-1 text-[11px] text-muted-foreground hover:text-foreground",
									children: ["All resellers ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3" })]
								}),
								children: /* @__PURE__ */ jsx("div", {
									className: "p-4",
									children: /* @__PURE__ */ jsx(TopList, {
				...
				supplierRows.length > 0 && /* @__PURE__ */ jsx(ReportCard, {
					...
					right: /* @__PURE__ */ jsxs("button", {
						...
						className: "inline-flex items-center gap-1 text-[11px] text-muted-foreground hover:text-foreground",
						children: ["All suppliers ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3" })]
					}),
					children: /* @__PURE__ */ jsx("div", {
						className: "p-4",
						children: /* @__PURE__ */ jsx(TopList, {
		...
		tab === "products" && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(ReportCard, {
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				}), /* @__PURE__ */ jsxs("tbody", { children: [pagedProducts.map((r) => /* @__PURE__ */ jsxs("tr", {
					className: "border-t",
					children: [
						/* @__PURE__ */ jsx("td", {
							className: "px-3 py-2",
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: r.image ? /* @__PURE__ */ jsx("img", {
										src: r.image,
										alt: r.name,
										loading: "lazy",
				...
				}, r.key)), pagedProducts.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
					colSpan: 8,
		...
		tab === "resellers" && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(ReportCard, {
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				}), /* @__PURE__ */ jsxs("tbody", { children: [pagedResellers.map((r) => /* @__PURE__ */ jsxs("tr", {
					className: "border-t",
					children: [
						/* @__PURE__ */ jsx("td", {
							className: "px-3 py-2",
						...
						/* @__PURE__ */ jsxs("td", {
							className: "px-3 py-2 text-center tabular-nums",
							children: [bdt(r.received), r.advance > 0 && /* @__PURE__ */ jsxs("div", {
				...
				}, r.key)), pagedResellers.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
					colSpan: 11,
					className: "px-3 py-10 text-center text-xs text-muted-foreground",
		...
		tab === "suppliers" && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(ReportCard, {
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				}), /* @__PURE__ */ jsxs("tbody", { children: [pagedSuppliers.map((s) => /* @__PURE__ */ jsxs("tr", {
					className: "border-t",
					children: [
						/* @__PURE__ */ jsx("td", {
							className: "px-3 py-2",
				...
				}, s.key)), pagedSuppliers.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
					colSpan: 5,
					className: "px-3 py-10 text-center text-xs text-muted-foreground",
		...
		tab === "couriers" && /* @__PURE__ */ jsx(ReportCard, {
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				}), /* @__PURE__ */ jsxs("tbody", { children: [courierRows.map((r) => /* @__PURE__ */ jsxs("tr", {
					className: "border-t",
					children: [
						/* @__PURE__ */ jsx("td", {
				...
				}, r.key)), courierRows.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
					colSpan: 11,
					className: "px-3 py-10 text-center text-xs text-muted-foreground",
		...
		tab === "agents" && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(ReportCard, {
			title: "Agent report",
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				}), /* @__PURE__ */ jsxs("tbody", { children: [pagedAgents.map((r) => /* @__PURE__ */ jsxs("tr", {
					className: "border-t",
					children: [
						/* @__PURE__ */ jsx("td", {
						...
						/* @__PURE__ */ jsx("td", {
							className: "px-3 py-2 text-center",
							children: r.target ? /* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsxs("td", {
							className: "px-3 py-2 text-center tabular-nums",
							children: [bdt(r.commission), /* @__PURE__ */ jsxs("div", {
				...
				}, r.key)), pagedAgents.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
					colSpan: 9,
					className: "px-3 py-10 text-center text-xs text-muted-foreground",
		...
		tab === "pnl" && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(ReportCard, {
			title: "Admin profit & loss",
			hint: "Admin profit = money received for the order − what the reseller finally earns − admin buying price of the products the customer kept. Advance already collected counts as received (the same way the transaction report does it). Delivery charge and packaging are not deducted twice here — record them once in Expenses and the net profit takes them out.",
			right: /* @__PURE__ */ jsxs(Link, {
				to: "/admin/expenses",
				className: "inline-flex items-center rounded-md border px-2.5 py-1.5 text-xs hover:bg-accent",
				children: [/* @__PURE__ */ jsx(Receipt, { className: "mr-1.5 h-3.5 w-3.5" }), " Manage expenses"]
			}),
			children: /* @__PURE__ */ jsx("table", {
				...
				children: /* @__PURE__ */ jsxs("tbody", { children: [
					...
					pnl.expenseByCategory.map((c) => /* @__PURE__ */ jsxs("tr", {
						className: "border-t",
						children: [/* @__PURE__ */ jsxs("td", {
...
var STATUS_STYLES = {
	new: {
		...
		text: "text-slate-600",
		icon: /* @__PURE__ */ jsx(CircleDot, { className: "h-3.5 w-3.5" })
	},
	forwarded: {
		bg: "bg-indigo-500/5 border-indigo-500/15",
		text: "text-indigo-600",
		icon: /* @__PURE__ */ jsx(Send, { className: "h-3.5 w-3.5" })
	},
	confirmed: {
		bg: "bg-blue-500/5 border-blue-500/15",
		text: "text-blue-600",
		icon: /* @__PURE__ */ jsx(ClipboardCheck, { className: "h-3.5 w-3.5" })
	},
	packaging: {
	...
	handover: {
		...
		icon: /* @__PURE__ */ jsx(PackageSearch, { className: "h-3.5 w-3.5" })
	},
	courier: {
		bg: "bg-cyan-500/5 border-cyan-500/15",
		text: "text-cyan-600",
		icon: /* @__PURE__ */ jsx(Truck, { className: "h-3.5 w-3.5" })
	},
	delivered: {
		bg: "bg-emerald-500/5 border-emerald-500/15",
		text: "text-emerald-600",
		icon: /* @__PURE__ */ jsx(PackageCheck, { className: "h-3.5 w-3.5" })
	},
	pending_partial: {
		bg: "bg-amber-500/5 border-amber-500/15",
		text: "text-amber-600",
		icon: /* @__PURE__ */ jsx(AlertTriangle, { className: "h-3.5 w-3.5" })
	},
	partial_full: {
		bg: "bg-amber-500/5 border-amber-500/15",
		text: "text-amber-600",
	...
	pending_return: {
		...
		icon: /* @__PURE__ */ jsx(Undo2, { className: "h-3.5 w-3.5" })
	},
	returned: {
	...
	cancelled: {
		...
		text: "text-gray-600",
		icon: /* @__PURE__ */ jsx(Ban, { className: "h-3.5 w-3.5" })
	},
	default: {

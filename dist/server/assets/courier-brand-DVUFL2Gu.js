...
var syncSteadfastStatus = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => z.object({ shipmentId: z.string().uuid() }).parse(d)).handler(createSsrRpc("c6c49de3f6491227dbde551eed3b3c2bcc4231efb3b653002613be16142ca04e"));
...
createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => z.object({
...
var syncPathaoStatus = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => z.object({ shipmentId: z.string().uuid() }).parse(d)).handler(createSsrRpc("bf9fef4de90b0c28b27f72e812816bf09ba4d58c398bb34af3a5cd424483b5a2"));
...
createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => z.object({ shipmentId: z.string().uuid() }).parse(d)).handler(createSsrRpc("f6aedff16c5414dd6af4bbe284597f8a5ec8f2970dcd28e0deddc7b1a23b3ad1"));
createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => z.object({
	shipmentId: z.string().uuid(),
...
var COURIER_BRANDS = {
	steadfast: {
		...
		mark: "/assets/steadfast-mark-Diw_GgYE.png",
		wordmark: "/assets/steadfast-wordmark-DHX2TqLv.png"
	},
	pathao: {
		id: "pathao",
		label: "Pathao Courier",
		mark: "/assets/pathao-mark-D88dviss.png",
		wordmark: "/assets/pathao-wordmark-CCltI6Ge.png"
	},
	carrybee: {
		id: "carrybee",
		label: "CarryBee",
		mark: "/assets/carrybee-mark-5-op3OiH.png",
		wordmark: "/assets/carrybee-wordmark-D3ca_14W.png"
	}
};

...
import { a as methodLabel, r as cfgString, t as MANUAL_METHODS } from "./payment-methods-CPLs2pOv.js";
...
import { Hand, Loader2, Plus, Trash2, Wallet, Zap } from "lucide-react";
...
function ManualMethods({ onCountChange }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			rows.length === 0 ? /* @__PURE__ */ jsxs("div", {
				...
				children: rows.map((row) => /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("span", {
									...
									children: paymentLogo(row.method) ? /* @__PURE__ */ jsx(PaymentLogo, {
										method: row.method,
										width: 96,
										height: 44,
										fit: "cover",
						...
						row.is_active && /* @__PURE__ */ jsx("span", {
			...
			draft && /* @__PURE__ */ jsx(MethodModal, {
				draft,
	...
	return /* @__PURE__ */ jsx(AppModal, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "Account type" }), /* @__PURE__ */ jsxs("select", {
					...
					children: [
						...
						ACCOUNT_TYPES.map((t) => /* @__PURE__ */ jsx("option", {
							value: t,
							children: t
						}, t)),
						(() => {
							const v = cfgString(row.config, "account_type");
							return v && !ACCOUNT_TYPES.includes(v) ? /* @__PURE__ */ jsx("option", {
								value: v,
								children: v
							}) : null;
						})()
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(TabButton, {
				...
				count: manualCount,
				children: [/* @__PURE__ */ jsx(Hand, { className: "h-3.5 w-3.5" }), " Manual"]
			}), /* @__PURE__ */ jsxs(TabButton, {
				active: tab === "api",
				onClick: () => setTab("api"),
				count: activeGateways,
				children: [/* @__PURE__ */ jsx(Zap, { className: "h-3.5 w-3.5" }), " Automatic"]
			})]
		}),
		/* @__PURE__ */ jsx("div", {
			className: tab === "manual" ? "" : "hidden",
			children: /* @__PURE__ */ jsx(ManualMethods, { onCountChange: setManualCount })
		}),
		/* @__PURE__ */ jsx("div", {
			className: tab === "api" ? "" : "hidden",
			children: /* @__PURE__ */ jsx(GatewayGrid, { onCountChange: setActiveGateways })
		})
	] });
}

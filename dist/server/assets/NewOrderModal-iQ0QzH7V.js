...
import { Nt as LoaderCircle, U as Search, lr as Building2, r as X, tr as Check, tt as Plus, v as Trash2, yt as Minus } from "./vendor-icons-DF2A5Z8S.js";
...
function NewOrderModal({ listings, allProducts, resellerId: initialResellerId, resellers = [], onClose, onCreated, isAdmin = false }) {
	...
	const effectiveResellers = (0, import_react.useMemo)(() => {
		return resellers && resellers.length > 0 ? resellers : initialData.resellers || [];
	}, [resellers]);

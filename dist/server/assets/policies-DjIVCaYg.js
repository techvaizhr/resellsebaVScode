...
import { t as fetchActivePolicies } from "./policies-FA9xsn6T.js";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(PageHeader, {
				...
				children: [/* @__PURE__ */ jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground" }), /* @__PURE__ */ jsx("input", {
					type: "text",
			...
			children: filtered.map((p, i) => /* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
					...
					children: p.points.map((point, idx) => /* @__PURE__ */ jsxs("li", {
						className: "flex items-start gap-2.5 text-xs sm:text-sm leading-relaxed text-muted-foreground",
						children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "mt-0.5 h-4 w-4 shrink-0 text-emerald-500" }), /* @__PURE__ */ jsx("span", {
					...
					children: [/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: "অফিসিয়াল নীতি" })]
					}), /* @__PURE__ */ jsxs("span", { children: [p.points.length, "টি নিয়মাবলী"] })]
				})]
			}, p.id))
		})]
	});

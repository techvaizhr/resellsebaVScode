...
import { r as cfgString } from "./payment-methods-riM5eEMo.js";
import { t as AppModal } from "./AppModal-C8qUvQNk.js";
import { a as fmtDate, c as requestManualPayment, d as savingPercent, m as statusLabel, n as cycleLabel, o as payFromEarning, r as fetchMySubscription, s as planPrice, t as CYCLES } from "./subscription-SIvaJJhk.js";
import { useEffect, useMemo, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { Check, CreditCard, LayoutDashboard, Loader2, ShieldCheck, Store, Wallet } from "lucide-react";
...
function SubscriptionPage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			state?.status === "grace" ? /* @__PURE__ */ jsxs("div", {
			...
			state?.status === "expired" ? /* @__PURE__ */ jsx("div", {
						...
						children: [
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										plan.includes_store ? /* @__PURE__ */ jsx(Store, { className: "h-4 w-4 text-primary" }) : /* @__PURE__ */ jsx(LayoutDashboard, { className: "h-4 w-4 text-primary" }),
										/* @__PURE__ */ jsx("h3", {
							...
							/* @__PURE__ */ jsxs("ul", {
								...
								children: [
									/* @__PURE__ */ jsxs("li", {
										...
										children: [/* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5 text-success" }), " Reseller panel, catalog and orders"]
									}),
									/* @__PURE__ */ jsxs("li", {
										className: "flex items-center gap-1.5",
										children: [
											/* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5 " + (plan.includes_store ? "text-success" : "text-muted-foreground/40") }),
			...
			/* @__PURE__ */ jsx(PaymentHistory, { rows: data?.payments ?? [] }),
			checkout ? /* @__PURE__ */ jsx(CheckoutModal, {
				plan: checkout.plan,
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { children: "Period" }),
...
function CheckoutModal({ plan, months, available, methods, onClose, onDone }) {
	...
	const [tab, setTab] = useState(available >= amount ? "earning" : "manual");
	...
	return /* @__PURE__ */ jsxs(AppModal, {
		...
		footer: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("button", {
				...
				children: [busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }) : null, tab === "earning" ? "Pay from earnings" : "Submit payment"]
			})]
		}),
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				available < amount ? /* @__PURE__ */ jsx("p", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
					...
					children: [methods.length === 0 ? /* @__PURE__ */ jsx("option", {
						value: "",
						children: "No method configured"
					}) : null, methods.map((m) => /* @__PURE__ */ jsx("option", {
						value: m.id,
						children: m.label
					}, m.id))]
				})] }),
				method ? /* @__PURE__ */ jsxs("div", {
					className: "rounded-lg border bg-muted/30 p-3",
					children: [cfgString(method.config, "account") ? /* @__PURE__ */ jsxs("div", {
					...
					}) : null, method.instructions ? /* @__PURE__ */ jsx("p", {

...
var sendTestNotification = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => z.object({
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("div", {
								...
								children: r.channel === "sms" ? /* @__PURE__ */ jsx(MessageSquare, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(Mail, { className: "h-4 w-4" })
							}),
							/* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							current.fields.map((f) => /* @__PURE__ */ jsx(Field, {
								label: f,
								children: /* @__PURE__ */ jsx("input", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("button", {
							...
							children: [/* @__PURE__ */ jsx(Send, { className: "h-3 w-3" }), " Send test"]
						})]
					})
				]
			}, r.channel);

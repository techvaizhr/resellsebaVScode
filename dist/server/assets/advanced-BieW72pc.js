...
import { t as clearAppDataCache } from "./app-data-tJP6g7R4.js";
import { n as PageHeader } from "./ui-kit-D-uo76H8.js";
import { c as pricingRuleSummary, i as mergeAdvanced, n as clearAdvancedSettingsCache, s as applyPricingRule, t as DEFAULT_ADVANCED_SETTINGS } from "./advanced-settings-SHMwKD5x.js";
import { n as fillText, r as mergeTexts, t as DEFAULT_DEPOSIT_TEXTS } from "./deposit-settings-CcRXewTz.js";
import { useEffect, useMemo, useRef, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { ArrowDown, ArrowUp, Boxes, ChevronDown, GripVertical, Info, ListFilter, Loader2, Mail, Package, Plus, RotateCcw, Save, ShieldCheck, Smartphone, Tag, Trash2, Truck, UserCheck, X } from "lucide-react";
			...
			children: [
				...
				rules.map((rule, i) => /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx(GripVertical, { className: "h-4 w-4 shrink-0 text-muted-foreground" }),
							/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							className: "space-y-2",
							children: [
								/* @__PURE__ */ jsx(Label, { children: "Charge" }),
								/* @__PURE__ */ jsx("div", {
								...
								rule.mode === "area" && /* @__PURE__ */ jsx("div", {
									className: "grid gap-2 sm:grid-cols-3",
									children: DELIVERY_AREAS.map((area) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
								...
								rule.mode === "flat" && /* @__PURE__ */ jsx("input", {
									type: "number",
									min: 0,
									value: rule.flat,
								...
								rule.mode === "custom" && /* @__PURE__ */ jsx("input", {
									type: "number",
									min: 0,
									value: rule.custom,
							...
							className: "space-y-2",
							children: [
								/* @__PURE__ */ jsx(Label, { children: "Apply on" }),
								/* @__PURE__ */ jsx(MultiPicker, {
								...
								!rule.target.products.length && !rule.target.brands.length && !rule.target.categories.length && /* @__PURE__ */ jsx("p", {
...
function MultiPicker({ placeholder, options, selected, onChange }) {
	...
	const chosen = useMemo(() => selected.map((id) => options.find((o) => o.id === id) ?? {
		id,
		label: id.slice(0, 8)
	}), [selected, options]);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				chosen.map((o) => /* @__PURE__ */ jsxs("span", {
			...
			children: filtered.length === 0 ? /* @__PURE__ */ jsx("p", {
				...
				children: "No match"
			}) : filtered.map((o) => /* @__PURE__ */ jsx("button", {
				type: "button",
				onClick: () => {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("h3", {
						...
						children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4 text-primary" }), " Live preview"]
					}),
					/* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("ul", {
						...
						children: [/* @__PURE__ */ jsxs("li", { children: ["• ", texts.howToDeposit] }), /* @__PURE__ */ jsxs("li", { children: ["• ", texts.withdrawWarning] })]
					})
				]
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
							...
							children: [
								"Use ",
								/* @__PURE__ */ jsx("code", { children: "{due}" }),
								", ",
								/* @__PURE__ */ jsx("code", { children: "{required}" }),
								", ",
								/* @__PURE__ */ jsx("code", { children: "{balance}" }),
								",",
								" ",
								/* @__PURE__ */ jsx("code", { children: "{frozen}" }),
							...
							children: [/* @__PURE__ */ jsx(RotateCcw, { className: "h-3.5 w-3.5" }), " Reset to default"]
						})]
					}),
					/* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("button", {
							...
							children: [busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Save, { className: "h-4 w-4" }), " Save deposit settings"]
						})
					})
				]
			})
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(PageHeader, {
				...
				actions: tab === "deposit" ? void 0 : /* @__PURE__ */ jsxs("button", {
					onClick: save,
					disabled: busy,
					className: "btn-brand inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm font-medium disabled:opacity-50",
					children: [busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Save, { className: "h-4 w-4" }), " Save changes"]
				})
			}),
			/* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Info, { className: "mt-0.5 h-4 w-4 shrink-0" }), /* @__PURE__ */ jsx("span", { children: tab === "deposit" ? "Deposit rule o reseller-facing text ekhan theke change korle sathe sathe reseller panel e apply hobe. Ei tab er nijer Save button ache." : "Ei switch gulo sathe sathe sob jaigai apply hoy — reseller panel, registration, login o dashboard." })]
			}),
			tab === "deposit" && /* @__PURE__ */ jsx(DepositSettingsPanel, {}),
			tab === "pricing" && /* @__PURE__ */ jsx(PricingCard, {
			...
			tab === "delivery" && /* @__PURE__ */ jsxs("div", {
				className: "space-y-5",
				children: [/* @__PURE__ */ jsx(DeliveryCard, {
					value: settings.delivery,
					onChange: (delivery) => setSettings((s) => ({
						...s,
						delivery
					}))
				}), /* @__PURE__ */ jsx(DeliveryRulesCard, {
					value: settings.delivery,
					onChange: (delivery) => setSettings((s) => ({
						...s,
						delivery
							...
							return /* @__PURE__ */ jsxs("label", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [
											row.key === "verifyEmail" && /* @__PURE__ */ jsx(Mail, { className: "h-3.5 w-3.5 text-muted-foreground" }),
											row.key === "verifySms" && /* @__PURE__ */ jsx(Smartphone, { className: "h-3.5 w-3.5 text-muted-foreground" }),
											row.label,
											row.master && /* @__PURE__ */ jsx("span", {
		...
		children: [/* @__PURE__ */ jsxs("header", {
			...
			children: [/* @__PURE__ */ jsxs("label", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						className: "grid gap-3 sm:grid-cols-2",
						children: [/* @__PURE__ */ jsx(MarkupField, {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("label", {
							...
							children: ["Default packaging charge (৳)", /* @__PURE__ */ jsx("input", {
								type: "number",
								min: 0,
								disabled: !value.enabled,
		...
		children: [/* @__PURE__ */ jsxs("header", {
			...
			children: [
				/* @__PURE__ */ jsx("div", {
					...
					children: DELIVERY_MODES.map((m) => /* @__PURE__ */ jsxs("button", {
						type: "button",
						onClick: () => onChange({
							...value,
							mode: m.value
				...
				value.mode === "area" && /* @__PURE__ */ jsxs("div", {
					className: "space-y-2",
					children: [/* @__PURE__ */ jsx("div", {
						className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground",
						children: "Areas (name change kora jabe)"
					}), DELIVERY_AREAS.map((area) => /* @__PURE__ */ jsxs("div", {
				...
				value.mode === "flat" && /* @__PURE__ */ jsxs("label", {
					className: "block max-w-xs text-xs font-medium",
					children: ["Flat charge (all areas)", /* @__PURE__ */ jsx("input", {
						type: "number",
						min: 0,
						value: value.flat,
						onChange: (e) => onChange({
				...
				value.mode === "custom" && /* @__PURE__ */ jsxs("label", {
					className: "block max-w-xs text-xs font-medium",
					children: [

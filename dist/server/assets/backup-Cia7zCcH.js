import { f as getToken, u as api } from "./client-Be051lUg.js";
...
import { AlertTriangle, Archive, Database, Download, FileCode2, FolderArchive, HardDrive, ImageIcon, Loader2, RefreshCw, RotateCcw, Search, Trash2, Upload } from "lucide-react";
...
function AdminBackupPage() {
	...
	async function handleCreateDb() {
		...
		try {
			...
			if (res.ok === false) throw new Error(res.error || res.message || "Failed to create database backup");
	...
	async function handleCreateFiles() {
		...
		try {
			...
			if (res.ok === false) throw new Error(res.error || res.message || "Failed to create media backup");
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
		children: [
			actionLoading && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Loader2, { className: "h-5 w-5 animate-spin text-primary shrink-0" }), /* @__PURE__ */ jsxs("div", {
					className: "text-sm",
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("button", {
							...
							children: creatingDb ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), " Exporting Database..."] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Database, { className: "h-4 w-4" }), " Create Database Backup (.sql)"] })
						}), /* @__PURE__ */ jsxs("div", {
							className: "relative",
							children: [/* @__PURE__ */ jsx("input", {
								...
								children: [/* @__PURE__ */ jsx(Upload, { className: "h-3.5 w-3.5 text-indigo-500" }), " Upload or Drag & Drop .SQL File"]
							})]
						})]
					})]
				}), /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(Archive, { className: "h-5 w-5" })
						}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
							className: "text-base font-semibold text-foreground",
						...
						children: [/* @__PURE__ */ jsx("button", {
							...
							children: creatingFiles ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), " Packing Images Archive..."] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(FolderArchive, { className: "h-4 w-4" }), " Create Images Backup (.zip)"] })
						}), /* @__PURE__ */ jsxs("div", {
							className: "relative",
							children: [/* @__PURE__ */ jsx("input", {
								ref: filesInputRef,
								...
								disabled: actionLoading,
								className: "flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-border bg-muted/40 px-4 py-2.5 text-xs font-medium text-foreground transition-colors hover:bg-muted disabled:opacity-50",
								children: [/* @__PURE__ */ jsx(Upload, { className: "h-3.5 w-3.5 text-emerald-500" }), " Upload or Drag & Drop .ZIP Archive"]
							})]
						})]
					})]
				})]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							className: "relative",
							children: [/* @__PURE__ */ jsx(Search, { className: "absolute left-2.5 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-muted-foreground" }), /* @__PURE__ */ jsx("input", {
								type: "text",
				...
				}) : filteredBackups.length === 0 ? /* @__PURE__ */ jsx("div", {
					className: "p-8",
					children: /* @__PURE__ */ jsx(EmptyState, {
						...
						icon: /* @__PURE__ */ jsx(HardDrive, { className: "h-10 w-10 text-muted-foreground/60" })
					})
				}) : /* @__PURE__ */ jsx("div", {
									...
									children: [
										/* @__PURE__ */ jsx("td", {
											...
											children: /* @__PURE__ */ jsxs("span", {
												...
												children: [isDb ? /* @__PURE__ */ jsx(FileCode2, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx(Archive, { className: "h-3.5 w-3.5" }), isDb ? "Database SQL" : "Images ZIP"]
											})
										}),
										/* @__PURE__ */ jsx("td", {
											...
											children: /* @__PURE__ */ jsxs("div", {
												...
												children: [
													/* @__PURE__ */ jsxs("button", {
														...
														children: [/* @__PURE__ */ jsx(Download, { className: "h-3.5 w-3.5 text-primary" }), " Download"]
													}),
													/* @__PURE__ */ jsxs("button", {
														type: "button",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "mt-0.5 h-5 w-5 shrink-0 text-amber-500" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {

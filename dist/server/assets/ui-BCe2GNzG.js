...
import { N as ShoppingBag } from "./vendor-icons-BWIzFOtW.js";
import { o as getStoreBootstrap } from "./bootstrap-rFaRbH29.js";
import { o as getPalette, s as getStoreTheme, t as createContentReader } from "./store-content-BESTlNEf.js";
import { t as buildMenuTree } from "./store-menu-C3c3MwZm.js";
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [img ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				...
				children: [free && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingBag, { className: "h-2.5 w-2.5" }),
						" ",
						saleCount,
						" Sold"
					]
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				...
				}), !free && variant !== "compact" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function ProductGrid({ listings }) {
	const { theme } = useStore();
	const cols = theme.layout.grid === "dense" ? "grid-cols-2 gap-2.5 sm:grid-cols-3 lg:grid-cols-5" : theme.layout.grid === "airy" ? "grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3" : "grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4";

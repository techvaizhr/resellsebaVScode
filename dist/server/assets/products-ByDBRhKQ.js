...
import { t as RichTextEditor } from "./RichTextEditor-DHPFEGPz.js";
import { t as Hint } from "./Hint-Ph3d-VhV.js";
import { a as importProductFromUrl, i as fetchImportImage, t as importImagesToStorage } from "./product-import-os-euaYQ.js";
import { d as saveSupplierProduct, m as supplierQuickUpdate, n as bdtNum, o as loadSupplierProducts, t as APPROVAL_TONE } from "./supplier-Iwv2PE9u.js";
import { n as useSupplier } from "./supplier-context-C2IdSO3T.js";
import { useCallback, useEffect, useMemo, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { CheckCircle2, Clock, CloudDownload, Copy, Eye, Loader2, PackageSearch, Pencil, Plus } from "lucide-react";
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("h3", {
						...
						children: ["Pricing & stock", role === "supplier" && /* @__PURE__ */ jsxs(Hint, {
							side: "right",
							children: [
								"The amount you receive per unit is the ",
								/* @__PURE__ */ jsx("b", { children: "Supplier price" }),
...
function SupplierProductsPage_() {
	...
	return /* @__PURE__ */ jsxs("div", { children: [
					...
					children: paged.map((p) => /* @__PURE__ */ jsxs("tr", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("td", {
								...
								children: [/* @__PURE__ */ jsx(InlineNumber, {
								...
								}), typeof p.pending_changes?.supplier_price !== "undefined" && /* @__PURE__ */ jsxs("div", {
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("span", {
											...
											children: [/* @__PURE__ */ jsx("span", { className: `h-1.5 w-1.5 rounded-full ${p.is_active ? "bg-emerald-500" : "bg-muted-foreground"}` }), p.is_active ? "Live" : "Hidden"]
										}),
										/* @__PURE__ */ jsx("div", {
										...
										p.pending_changes && /* @__PURE__ */ jsx("div", {
											className: "text-[10px] text-amber-600",
											children: "Edit waiting"
										}),
										p.approval_note && /* @__PURE__ */ jsx("div", {
										...
										/* @__PURE__ */ jsxs(ActionMenu, {
											...
											children: [
												...
												/* @__PURE__ */ jsxs(DropdownMenuItem, {
													...
													children: [/* @__PURE__ */ jsx(Pencil, { className: "mr-2 h-4 w-4" }), " Edit (needs approval)"]
												}),
												/* @__PURE__ */ jsxs(DropdownMenuItem, {
													onSelect: () => {
		...
		detail && /* @__PURE__ */ jsx(SupplierProductDetail, {
			product: detail,
			brands,
			categories,
		...
		importOpen && /* @__PURE__ */ jsx(ImportModal, {
			supplierId,
		...
		editing !== void 0 && /* @__PURE__ */ jsx(ProductForm, {
			product: editing,
			prefill,
			supplierId,
			brands,
	...
	return /* @__PURE__ */ jsx(AppModal, {
		...
		footer: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("button", {
				...
				onClick: onEdit,
				className: "btn-brand inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm font-medium",
				children: [/* @__PURE__ */ jsx(Pencil, { className: "h-4 w-4" }), " Edit (needs approval)"]
			})]
		}),
		children: /* @__PURE__ */ jsxs("div", {
			className: "space-y-4",
			children: [
				images.length > 0 && /* @__PURE__ */ jsx("div", {
					...
					children: images.map((im, i) => /* @__PURE__ */ jsx("img", {
						src: im.url,
						alt: "",
				...
				product.pending_changes && /* @__PURE__ */ jsx("div", {
				...
				product.approval_note && /* @__PURE__ */ jsx("div", {
...
function InlineNumber({ value, prefix, suffix, onSave }) {
	...
	if (!editing) return /* @__PURE__ */ jsxs("button", {
		...
		children: [
			busy && /* @__PURE__ */ jsx(Loader2, { className: "h-3 w-3 animate-spin" }),
			prefix,
			value,
			suffix,
			/* @__PURE__ */ jsx(Pencil, { className: "h-3 w-3 shrink-0 text-muted-foreground" })
		]
	});
	...
	return /* @__PURE__ */ jsx(AppModal, {
		...
		footer: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("button", {
				...
				className: "btn-brand inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm font-medium disabled:opacity-50",
				children: [busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(CloudDownload, { className: "h-4 w-4" }), " Fetch"]
			})]
		}),
		children: /* @__PURE__ */ jsxs("form", {
...
function ProductForm({ product, prefill, supplierId, brands, categories, onClose, onSaved }) {
	...
	return /* @__PURE__ */ jsx(ProductFormModal, {
		role: "supplier",

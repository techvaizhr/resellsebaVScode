...
import { i as DEFAULT_ORDER_FILTERS, l as resolveDateRange, n as COURIER_FILTER_OPTIONS, r as DATE_PRESET_OPTIONS, t as AREA_FILTER_OPTIONS } from "./order-filters-C0seZ87w.js";
import { i as usePaginated, r as Pagination } from "./data-list-Cd6RJIu_.js";
import { i as courierLabel, n as CourierLogo } from "./courier-brand-DKAm6Vr-.js";
import { t as BulkScanButton } from "./BulkScanModal-Fmfkwu6s.js";
import { t as CopyOrderNumber } from "./CopyOrderNumber-CeUzA8ah.js";
import { i as orderSupplierTint, r as ShipmentBookingModal, t as printLabelDocs } from "./labels-TS7Lg7wD.js";
import { a as OrderNotePreview, d as OrderProductCell, l as ImageLightbox, n as courierTrackingUrl, o as OrderNotesModal, r as OrderTabs, s as useOrderMeta, t as OrderSearch, u as OrderItemsList } from "./order-search-Dnzvl01g.js";
import { n as bdtNum } from "./supplier-Iwv2PE9u.js";
import { n as useSupplier } from "./supplier-context-C2IdSO3T.js";
import { useCallback, useEffect, useMemo, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { CheckSquare, ChevronDown, ExternalLink, Loader2, PackageCheck, Printer, RefreshCw, Truck } from "lucide-react";
...
function SupplierOrdersPage() {
	...
	const myTint = useMemo(() => orderSupplierTint([supplierData.supplier?.id ?? null]), [supplierData.supplier?.id]);
	...
	const stripItems = useCallback((o) => o.items.map((it) => ({
		id: it.id,
		product_id: null,
	...
	const scanResolve = useCallback((code) => {
	...
	const scanApply = useCallback(async (order, to) => {
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsx(PageHeader, {
			...
			actions: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(BulkScanButton, {
					compact: true,
					mode: "handover",
					modes: ["handover"],
					resolve: scanResolve,
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						bulkNext && /* @__PURE__ */ jsxs("button", {
							...
							children: [
								busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ jsx(PackageCheck, { className: "h-3.5 w-3.5" }),
								marked.length,
								" → ",
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsx("button", {
											...
											children: /* @__PURE__ */ jsx(ChevronDown, { className: `h-4 w-4 transition-transform ${open ? "rotate-180" : ""}` })
										})
									]
								}),
								/* @__PURE__ */ jsx("div", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [isBooked(o) ? /* @__PURE__ */ jsx(CourierCell, {
										shipment: o.shipment,
										...
										children: [/* @__PURE__ */ jsx(Truck, { className: "h-3.5 w-3.5" }), " Book courier"]
										...
										children: [next === "packaging" ? /* @__PURE__ */ jsx(Truck, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx(PackageCheck, { className: "h-3.5 w-3.5" }), supplierStatusLabel(next)]
									}) : /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx(OrderNotePreview, {
										meta: meta[o.id],
										onOpenNotes: () => setNotesModal({
											orderId: o.id,
											orderNumber: o.order_number
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: isBooked(o) ? /* @__PURE__ */ jsx(CourierCell, {
										...
										children: [/* @__PURE__ */ jsx(Truck, { className: "h-3 w-3" }), " Book"]
									})
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "flex flex-col items-center gap-1.5",
									children: [/* @__PURE__ */ jsx("span", {
										...
										children: [next === "packaging" ? /* @__PURE__ */ jsx(Truck, { className: "h-3 w-3" }) : /* @__PURE__ */ jsx(PackageCheck, { className: "h-3 w-3" }), supplierStatusLabel(next)]
									}) : /* @__PURE__ */ jsx("span", {
		...
		confirm && /* @__PURE__ */ jsx(ConfirmModal, {
			isOpen: true,
			variant: "info",
			title: confirm.title,
...
function CourierCell({ shipment, customerPhone }) {
	if (!shipment?.provider) return /* @__PURE__ */ jsx("span", {
	...
	const label = /* @__PURE__ */ jsxs("span", {
		...
		children: [courierLabel(shipment.provider), url && /* @__PURE__ */ jsx(ExternalLink, { className: "h-2.5 w-2.5 shrink-0 opacity-60" })]
	});
	return /* @__PURE__ */ jsxs("div", {

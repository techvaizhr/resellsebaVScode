...
import { a as getPlatformOrigins, c as saveCloudflareConfig, d as testCloudflareConfig, l as savePlatformOrigins, n as disconnectDomain, o as listDomains, r as getCloudflareConfig, s as refreshDomain } from "./cloudflare.functions-B4Yv0XKW.js";
import { useEffect, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { AlertCircle, CheckCircle2, Globe, Loader2, Plug, RefreshCw, Save, Server, ShieldCheck, Trash2 } from "lucide-react";
...
function DomainsAdmin() {
	...
	const field = (key, label, placeholder, type = "text") => /* @__PURE__ */ jsxs("label", {
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		...
		/* @__PURE__ */ jsx(PlatformOriginsCard, {}),
		/* @__PURE__ */ jsxs("form", {
			onSubmit: onSave,
			className: "space-y-6",
			children: [
				...
				form.mode !== "cloudflare" && /* @__PURE__ */ jsxs("div", {
					className: "surface-card space-y-4 p-5",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2 text-sm font-semibold",
							children: [/* @__PURE__ */ jsx(Server, { className: "h-4 w-4 text-primary" }), " Server DNS setup"]
						}),
						/* @__PURE__ */ jsxs("div", {
				...
				form.mode !== "dns" && /* @__PURE__ */ jsxs("div", {
					className: "surface-card space-y-4 p-5",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2 text-sm font-semibold",
							children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4 text-primary" }), " Cloudflare credentials"]
						}),
						/* @__PURE__ */ jsxs("label", {
							className: "flex flex-col gap-1",
							children: [
								/* @__PURE__ */ jsxs("span", {
									className: "text-xs font-medium text-muted-foreground",
									children: ["API token ", hasToken && /* @__PURE__ */ jsxs("span", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("button", {
						...
						children: [busy === "save" ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Save, { className: "h-4 w-4" }), " Save"]
					}), form.mode !== "dns" && /* @__PURE__ */ jsxs("button", {
						type: "button",
						onClick: onTest,
						disabled: busy === "test",
						className: "inline-flex items-center gap-1.5 rounded-md border px-4 py-2 text-sm font-medium hover:bg-muted",
						children: [busy === "test" ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Plug, { className: "h-4 w-4" }), " Test connection"]
					})]
				})
			]
		}),
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: r.verified_at ? /* @__PURE__ */ jsxs("span", {
...
function PlatformOriginsCard() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				className: "flex items-center gap-2 text-sm font-semibold",
				children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4 text-primary" }), " Payment redirect domains"]
			}),
			/* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsxs("button", {
				...
				children: [saving ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Save, { className: "h-4 w-4" }), " Save domains"]
			})
		]
	});
}

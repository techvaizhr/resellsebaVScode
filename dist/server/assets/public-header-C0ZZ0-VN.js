...
function Brand({ siteName, logoUrl, size = "md" }) {
	...
	if (effectiveLogo) return /* @__PURE__ */ jsx("img", {
		src: effectiveLogo,
		alt: siteName,
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("nav", {
					...
					children: navLinks.map((l) => l.to ? /* @__PURE__ */ jsxs(Link, {
						to: l.to,
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("button", {
							...
							children: menu ? /* @__PURE__ */ jsx(X, { className: "h-5 w-5" }) : /* @__PURE__ */ jsx(Menu, { className: "h-5 w-5" })
						})
					]
				})
			]

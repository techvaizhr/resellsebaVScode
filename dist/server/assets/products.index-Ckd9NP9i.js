...
import { t as Route } from "./products.index-CQlPGoZ7.js";
import { n as PageHeader, t as EmptyState } from "./ui-kit-D-uo76H8.js";
import { o as useAdvancedSettings } from "./advanced-settings-SHMwKD5x.js";
import { r as useCan } from "./use-auth-L4LMIQqu.js";
import { t as Button } from "./button-BkEeRci-.js";
import { a as DropdownMenuSeparator, r as DropdownMenuItem } from "./dropdown-menu-BtjXROHi.js";
...
import { n as ImageDownloadTools, r as stripHtml, t as CopyButton } from "./reseller-tools-8ryd3dba.js";
import { t as ProductImportModal } from "./ProductImportModal-C1PTBomX.js";
import { f as setProductSupplier, t as APPROVAL_TONE, u as reviewProduct } from "./supplier-Iwv2PE9u.js";
import { useEffect, useMemo, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { Check, CheckSquare, ChevronDown, ChevronRight, CloudDownload, Copy, Eye, EyeOff, Loader2, Lock, Pencil, Plus, Square, Trash2, Truck, Unlock, Wand2, X } from "lucide-react";
...
function PendingChangesModal({ productId, productName, pendingChanges, brands = [], categories = [], onClose, onReviewed }) {
	...
	return /* @__PURE__ */ jsxs(AppModal, {
		...
		size: "lg",
		children: [!current ? /* @__PURE__ */ jsx("div", {
			...
			children: keys.map((k) => {
				...
				return /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						k === "images" && /* @__PURE__ */ jsx("div", {
							className: "mt-2 flex flex-wrap gap-2",
							children: (Array.isArray(after) ? after : []).slice(0, 8).map((im, idx) => /* @__PURE__ */ jsx("img", {
								src: im.url,
								alt: "",
			...
			children: [
				...
				/* @__PURE__ */ jsxs(Button, {
					...
					onClick: () => act(false),
					disabled: !!busy,
					children: [busy === "reject" ? /* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(X, { className: "mr-2 h-4 w-4" }), "Reject"]
				}),
				/* @__PURE__ */ jsxs(Button, {
					onClick: () => act(true),
					disabled: !!busy,
					children: [busy === "approve" ? /* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Check, { className: "mr-2 h-4 w-4" }), "Approve"]
				})
			]
		})]
	});
...
function BulkValuePanel({ count, busy, onApply }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("button", {
			...
			children: [
				open ? /* @__PURE__ */ jsx(ChevronDown, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx(ChevronRight, { className: "h-3.5 w-3.5" }),
				...
				active.length > 0 && !open && /* @__PURE__ */ jsxs("span", {
			...
			children: [FIELDS.map((f) => {
				...
				return /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						f.percent ? /* @__PURE__ */ jsxs("select", {
							disabled: !s.on,
							value: s.mode,
				...
				children: [
					/* @__PURE__ */ jsxs("button", {
						...
						children: [
							busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ jsx(Wand2, { className: "h-3.5 w-3.5" }),
							"Apply to ",
							count,
							" product",
							count === 1 ? "" : "s"
...
function ProductsPage() {
	...
	const [items, setItems] = useState(catalogCache?.products ?? []);
	const [brands, setBrands] = useState(catalogCache?.brands ?? []);
	const [categories, setCategories] = useState(catalogCache?.categories ?? []);
	const [suppliers, setSuppliers] = useState(catalogCache?.suppliers ?? []);
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsx(PageHeader, {
			title: /* @__PURE__ */ jsxs("span", {
				...
				children: ["Products", /* @__PURE__ */ jsx("span", {
			...
			actions: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					canManage && /* @__PURE__ */ jsxs("button", {
						...
						children: [inlineEdit ? /* @__PURE__ */ jsx(Unlock, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(Lock, { className: "h-4 w-4" }), inlineEdit ? "Inline edit: ON" : "Inline edit: OFF"]
					}),
					canManage && /* @__PURE__ */ jsxs("button", {
						type: "button",
		...
		/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx("div", {
				...
				children: statusButtons.map(([value, label, count]) => /* @__PURE__ */ jsxs("button", {
					type: "button",
		...
		loading ? /* @__PURE__ */ jsx("div", {
			...
			action: canManage ? /* @__PURE__ */ jsxs(Link, {
				to: "/admin/products/new",
				className: "btn-brand inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm font-medium",
			...
			selected.size > 0 && /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							canManage && /* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(Eye, { className: "h-3.5 w-3.5" }), " Activate"]
							}),
							canManage && /* @__PURE__ */ jsxs("button", {
								disabled: bulkBusy,
								onClick: () => bulkSetActive(false),
								className: "inline-flex items-center gap-1 rounded-md border px-3 py-1.5 text-xs font-medium hover:bg-background disabled:opacity-50",
								children: [/* @__PURE__ */ jsx(EyeOff, { className: "h-3.5 w-3.5" }), " Hide"]
							}),
							canManage && /* @__PURE__ */ jsxs("button", {
								disabled: bulkBusy,
							...
							canManage && /* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(X, { className: "h-3.5 w-3.5" }), " Reject"]
							}),
					...
					canManage && /* @__PURE__ */ jsx(BulkValuePanel, {
						count: selected.size,
						busy: bulkBusy,
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", {
						...
						children: /* @__PURE__ */ jsxs("tr", { children: [
							/* @__PURE__ */ jsx("th", {
								...
								children: /* @__PURE__ */ jsx("button", {
									...
									children: paged.length > 0 && paged.every((p) => selected.has(p.id)) ? /* @__PURE__ */ jsx(CheckSquare, { className: "h-4 w-4 text-primary" }) : /* @__PURE__ */ jsx(Square, { className: "h-4 w-4" })
								})
							}),
							/* @__PURE__ */ jsx("th", {
						...
						className: "divide-y",
						children: paged.map((p) => /* @__PURE__ */ jsxs("tr", {
							...
							children: [
								/* @__PURE__ */ jsx("td", {
									...
									children: /* @__PURE__ */ jsx("button", {
										...
										className: "text-muted-foreground hover:text-primary",
										"aria-label": "Select",
										children: selected.has(p.id) ? /* @__PURE__ */ jsx(CheckSquare, { className: "h-4 w-4 text-primary" }) : /* @__PURE__ */ jsx(Square, { className: "h-4 w-4" })
									})
								}),
								/* @__PURE__ */ jsx("td", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											...
											children: [/* @__PURE__ */ jsx("div", {
												...
												children: [
													...
													p.brand_id && brands.find((b) => b.id === p.brand_id) && /* @__PURE__ */ jsx("span", {
														className: "inline-flex items-center rounded bg-muted px-1.5 py-0.5",
														children: brands.find((b) => b.id === p.brand_id).name
													}),
													p.category_id && categories.find((c) => c.id === p.category_id) && /* @__PURE__ */ jsx("span", {
														className: "inline-flex items-center rounded bg-muted px-1.5 py-0.5",
								...
								/* @__PURE__ */ jsx("td", {
									...
									children: /* @__PURE__ */ jsx("div", {
										...
										children: /* @__PURE__ */ jsx(SupplierCell, {
											row: p,
											suppliers
										})
									})
								...
								/* @__PURE__ */ jsx("td", {
									className: "px-3 py-3 text-center",
									children: /* @__PURE__ */ jsx(PriceCell, {
								...
								/* @__PURE__ */ jsx("td", {
									className: "px-3 py-3 text-center",
									children: /* @__PURE__ */ jsx(StockCell, {
										locked: !inlineEdit || !canManage,
										row: p,
										onSaved: (v) => setItems((s) => s.map((i) => i.id === p.id ? {
											...i,
								...
								/* @__PURE__ */ jsxs("td", {
									...
									children: [/* @__PURE__ */ jsx(WeightCell, {
										locked: !inlineEdit || !canManage,
										row: p,
										onSaved: (v) => setItems((s) => s.map((i) => i.id === p.id ? {
											...i,
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsxs("span", {
												...
												children: [/* @__PURE__ */ jsx("span", { className: `h-1.5 w-1.5 rounded-full ${p.is_active ? "bg-emerald-500" : "bg-muted-foreground"}` }), p.is_active ? "Active" : "Hidden"]
											}),
											(p.approval_status ?? "approved") !== "approved" && /* @__PURE__ */ jsx("div", {
											...
											canManage && p.pending_changes && Object.keys(p.pending_changes).length > 0 && /* @__PURE__ */ jsxs("button", {
												type: "button",
											...
											/* @__PURE__ */ jsxs(ActionMenu, {
												...
												children: [
													...
													canManage && ((p.approval_status ?? "approved") !== "approved" || p.pending_changes) && /* @__PURE__ */ jsxs(Fragment, { children: [
														/* @__PURE__ */ jsxs(DropdownMenuItem, {
															onSelect: () => setReviewFor(p),
															children: [/* @__PURE__ */ jsx(Eye, { className: "mr-2 h-4 w-4" }), " Review changes"]
														}),
														/* @__PURE__ */ jsxs(DropdownMenuItem, {
															onSelect: () => review(p, true),
															children: [/* @__PURE__ */ jsx(Check, { className: "mr-2 h-4 w-4" }), " Approve submission"]
														}),
														/* @__PURE__ */ jsxs(DropdownMenuItem, {
															onSelect: () => review(p, false),
															children: [/* @__PURE__ */ jsx(X, { className: "mr-2 h-4 w-4" }), " Reject submission"]
														})
													] }),
													canManage && /* @__PURE__ */ jsx(DropdownMenuItem, {
														onSelect: () => toggle(p),
														children: p.is_active ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(EyeOff, { className: "mr-2 h-4 w-4" }), " Hide"] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Eye, { className: "mr-2 h-4 w-4" }), " Show"] })
													}),
													canDelete && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(DropdownMenuSeparator, {}), /* @__PURE__ */ jsxs(DropdownMenuItem, {
		...
		assignFor && /* @__PURE__ */ jsx(AssignSupplierModal, {
			row: assignFor,
			suppliers,
		...
		reviewFor && /* @__PURE__ */ jsx(PendingChangesModal, {
		...
		detailId && /* @__PURE__ */ jsx(ProductDetailModal, {
			id: detailId,
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						}), imageUrls.length > 1 && /* @__PURE__ */ jsx("div", {
							className: "flex gap-2 overflow-x-auto pb-2 pt-1 max-w-full no-scrollbar sm:flex-wrap",
							children: imageUrls.map((url, i) => /* @__PURE__ */ jsx("button", {
								type: "button",
...
function StockCell({ row, onSaved, locked }) {
	...
	if (!editing) return /* @__PURE__ */ jsx("button", {
		onClick: () => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("button", {
				...
				children: busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Check, { className: "h-4 w-4" })
			}),
			/* @__PURE__ */ jsx("button", {
...
function PriceCell({ row, field, onSaved, locked }) {
	...
	if (locked) return /* @__PURE__ */ jsxs("span", {
		className: "px-2 py-0.5 text-xs",
		title: "Turn on Inline edit to change price",
		children: ["৳", current]
	});
	if (!editing) return /* @__PURE__ */ jsxs("button", {
		onClick: () => {
...
function SupplierCell({ row, suppliers }) {
	...
	if (!row.supplier_id) return /* @__PURE__ */ jsx("span", {

...
var sendVerificationCode = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => objectType({ channel: enumType(["email", "sms"]) }).parse(d)).handler(sendVerificationCode_createServerFn_handler, async ({ data, context }) => {

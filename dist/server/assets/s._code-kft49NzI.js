...
import { Ct as Menu, N as ShoppingBag, Nt as LoaderCircle, St as MessageCircle, U as Search, er as ChevronDown, it as Phone, r as X } from "./vendor-icons-DF2A5Z8S.js";
import { t as Route } from "./s._code-DKZDARlL.js";
import { c as borderc, d as useStore, f as useStoreLoader, l as cx, r as Heading, u as muted } from "./ui-v9g8zAru.js";
import { l as storeThemeStyle } from "./store-content-uAaIXYBj.js";
import { i as menuTarget } from "./store-menu-Bcykva_e.js";
import { n as PwaInstallButton } from "./pwa-install-crXdrYEy.js";
import { i as useStoreVisitLog } from "./store-visits-vTtiQO9s.js";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		...
		children: [settings?.logo_url ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heading, {
				...
				children: name
			}), settings?.tagline && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function SearchBox({ className }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: cx("pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2", muted) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
			value: q,
...
function MenuLabel({ node, className, onClick, children }) {
	...
	if (target.kind === "route") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
		to: target.to,
	...
	if (target.kind === "route-slug") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
		to: target.to,
		params: target.params,
		className,
		onClick,
	...
	if (target.kind === "external") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
		href: target.href,
...
function MenuPanel({ node }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: node.children.map((child) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: mega ? "min-w-0" : "group/sub relative min-w-0",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(MenuLabel, {
					node: child,
					...
					children: [
						mega && child.image_url && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							src: child.image_url,
							alt: child.label,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							}), mega && child.description && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: cx("block truncate text-[11px]", "text-[var(--st-muted)]"),
								children: child.description
							})]
						}),
						!mega && child.children.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "h-3.5 w-3.5 shrink-0 -rotate-90 opacity-70" })
					]
				}), child.children.length > 0 && (mega ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-1 flex flex-col gap-0.5 pl-2",
					children: child.children.map((leaf) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuLabel, {
						node: leaf,
...
function StoreNav({ variant }) {
	...
	const [openChildId, setOpenChildId] = (0, import_react.useState)(null);
	...
	if (variant === "stack") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
		className: "flex flex-col gap-1",
		children: items.map((node) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center gap-1",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuLabel, {
				node,
				className: cx(base, "flex-1 py-2")
			}), node.children.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				type: "button",
				"aria-label": `Toggle ${node.label}`,
				onClick: () => setOpenId((v) => v === node.id ? null : node.id),
				className: "rounded p-1.5 hover:bg-[var(--st-bg-alt)]",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: cx("h-4 w-4 transition-transform", openId === node.id && "rotate-180") })
			})]
		}), openId === node.id && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: cx("ml-3 border-l pl-3", "border-[var(--st-border)]"),
			children: node.children.map((child) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-1",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuLabel, {
					node: child,
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						children: [child.image_url && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							src: child.image_url,
							alt: child.label,
							className: "h-7 w-7 rounded object-cover"
						}), child.label]
					})
				}), child.children.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
					"aria-label": `Toggle ${child.label}`,
					onClick: () => setOpenChildId((v) => v === child.id ? null : child.id),
					className: "rounded p-1.5 hover:bg-[var(--st-bg-alt)]",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: cx("h-3.5 w-3.5 transition-transform", openChildId === child.id && "rotate-180") })
				})]
			}), openChildId === child.id && child.children.map((leaf) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuLabel, {
				node: leaf,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
		...
		children: items.map((node) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(MenuLabel, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: node.label
				}), node.children.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "h-3.5 w-3.5 opacity-70" })]
			}), node.children.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuPanel, { node })]
		}, node.id))
	});
}
...
function StoreHeader() {
	...
	const defaultNotice = theme.id === "bazaar" ? "🇧🇩 সারা দেশে ক্যাশ অন ডেলিভারি | ডেলিভারির সময় পার্সেল চেক করে টাকা দিন | কোনো অগ্রিম পেমেন্ট নেই" : theme.id === "noir" ? "✨ LUXURY CURATION — 100% AUTHENTIC & PREMIUM QUALITY GUARANTEED" : theme.id === "atelier" ? "🌿 ১০০% খাঁটি ও নির্ভেজাল পণ্য — সরাসরি প্রাকৃতিক সোর্স থেকে সংগৃহীত" : "⚡ দ্রুততম হোম ডেলিভারি ও শতভাগ অরিজিনাল প্রোডাক্ট গ্যারান্টি";
	const bannerText = announcement || defaultNotice;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "sticky top-0 z-40",
		children: [bannerText && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "bg-[var(--st-primary)] px-4 py-1.5 text-center text-[12px] font-semibold text-[var(--st-on-primary)] tracking-wide shadow-xs",
			children: bannerText
		}), v === "bar" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchBox, { className: "hidden flex-1 md:block" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "ml-auto flex items-center gap-2 text-[var(--st-on-primary)]",
								children: [settings?.support_phone && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CartButton, {})
								})]
							})
						]
					})
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CategoryNav, { variant: "row" })
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		}) : v === "classic" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchBox, { className: "hidden w-64 lg:block" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CartButton, {})]
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchBox, { className: "mb-3" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CategoryNav, { variant: "stack" })]
			})]
		}) : v === "editorial" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchBox, { className: "hidden w-56 lg:block" }),
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logo, {}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchBox, { className: "mx-auto hidden max-w-md flex-1 md:block" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "ml-auto flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CartButton, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								className: "md:hidden",
								"aria-label": "Menu",
								onClick: () => setOpen((o) => !o),
								children: open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "h-5 w-5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Menu, { className: "h-5 w-5" })
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-4",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PwaInstallButton, {
								variant: "footer",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					}), categories.slice(0, 6).map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/s/$code/c/$slug",
						params: {
							code,
							slug: c.slug
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						settings?.support_phone && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							href: `tel:${settings.support_phone}`,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Delivery: 1–3 days (Dhaka), 2–5 days (outside)" })
					]
				})] })
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function FloatingQuickOrder() {
	const { settings } = useStore();
	const phone = settings?.support_phone || settings?.whatsapp;
	const wa = settings?.whatsapp;
	if (!phone && !wa) return null;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "fixed bottom-5 right-4 z-50 flex flex-col items-end gap-2 pointer-events-auto",
		children: [wa && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute inline-flex h-full w-full animate-ping rounded-full bg-white opacity-75" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "relative inline-flex h-2.5 w-2.5 rounded-full bg-white" })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "h-4 w-4 fill-white" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "হোয়াটসঅ্যাপে অর্ডার" })
			]
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Phone, { className: "h-4 w-4 fill-current" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "কল করুন" })]
		})]
	});
}
//#endregion
...
function StoreLayout() {
	...
	if (state === "closed") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	if (state === "missing" || !store) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "grid min-h-screen place-items-center p-6 text-center",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
			className: "text-2xl font-semibold",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingQuickOrder, {})
			]
		})
	});
}

...
import { a as bdt } from "./agents-DEk14i6g.js";
import { r as useCan } from "./use-auth-L4LMIQqu.js";
import { useEffect, useMemo, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { Loader2, Mail, Pencil, Phone, Plus, Power, Search, Target, Trash2, UserCheck, Users, X } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsx(PageHeader, {
			...
			actions: canManage ? /* @__PURE__ */ jsxs("button", {
				...
				children: [/* @__PURE__ */ jsx(Plus, { className: "h-4 w-4" }), " Add agent"]
			}) : void 0
		}),
		...
		}) : agents.length === 0 ? /* @__PURE__ */ jsx(EmptyState, {
			title: "No agents yet",
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: [a.email && /* @__PURE__ */ jsxs("span", {
					...
					canManage && /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(Users, { className: "h-3.5 w-3.5" }), " Assign resellers"]
							}),
							/* @__PURE__ */ jsxs("button", {
							...
							/* @__PURE__ */ jsx("button", {
								...
								children: /* @__PURE__ */ jsx(Power, { className: "h-3.5 w-3.5" })
							}),
							/* @__PURE__ */ jsx("button", {
		...
		editing && /* @__PURE__ */ jsx(AgentModal, {
		...
		assignFor && /* @__PURE__ */ jsx(AssignModal, {
			agent: assignFor,
			resellers,
					...
					children: [
						/* @__PURE__ */ jsxs("div", { children: [
							...
							/* @__PURE__ */ jsxs("select", {
								...
								}), available.map((c) => /* @__PURE__ */ jsx("option", {
									value: c.user_id,
...
function AssignModal({ agent, resellers, onClose, onSaved }) {
	...
	const [selected, setSelected] = useState(resellers.filter((r) => r.agent_id === agent.id).map((r) => r.id));
	const [busy, setBusy] = useState(false);
	const list = useMemo(() => {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [list.length === 0 && /* @__PURE__ */ jsx("p", {
						...
						return /* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: on && /* @__PURE__ */ jsx(UserCheck, { className: "h-3 w-3" })
							}), /* @__PURE__ */ jsxs("span", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("button", {
						...
						disabled: busy,
						className: "btn-brand inline-flex items-center justify-center gap-2 rounded-md px-4 py-2 text-sm font-semibold",
						children: [busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Target, { className: "h-4 w-4" }), " Save assignments"]
					})]
				})
			]
		})

...
import { CheckCircle2, Code2, Edit3, ExternalLink, Eye, Loader2, Save, ShieldCheck, Sparkles } from "lucide-react";
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(PageHeader, {
				...
				children: [/* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsx(ExternalLink, { className: "h-3.5 w-3.5 text-muted-foreground" }), /* @__PURE__ */ jsx("span", { children: "View Public Page" })]
					...
					children: [busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Save, { className: "h-4 w-4" }), /* @__PURE__ */ jsx("span", { children: "Save Changes" })]
				})]
			})]
		}), /* @__PURE__ */ jsxs("div", {
			...
			children: [
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(Edit3, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: "Visual Editor" })]
							}),
							/* @__PURE__ */ jsxs("button", {
								type: "button",
								...
								children: [/* @__PURE__ */ jsx(Code2, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: "HTML Source" })]
							}),
							/* @__PURE__ */ jsxs("button", {
								type: "button",
								...
								children: [/* @__PURE__ */ jsx(Eye, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: "Live Preview" })]
							})
						]
					}), /* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: "Starters:"
						}), TEMPLATES.map((tmpl, idx) => /* @__PURE__ */ jsxs("button", {
							type: "button",
							...
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3 w-3 text-amber-500" }), /* @__PURE__ */ jsx("span", { children: idx === 0 ? "Standard" : "Minimal" })]
						}, idx))]
					})]
				}),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						mode === "visual" && /* @__PURE__ */ jsxs("div", {
							className: "space-y-2",
							children: [/* @__PURE__ */ jsxs("div", {
								className: "text-xs text-muted-foreground mb-2 flex items-center gap-1.5",
								children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-3.5 w-3.5 text-emerald-500" }), /* @__PURE__ */ jsx("span", { children: "Easy Visual Mode — type directly, create bullet points, headings, and bold text without touching HTML." })]
							}), /* @__PURE__ */ jsx("div", {
						...
						mode === "code" && /* @__PURE__ */ jsxs("div", {
							className: "space-y-2",
							children: [/* @__PURE__ */ jsxs("div", {
								className: "text-xs text-muted-foreground mb-2 flex items-center gap-1.5",
								children: [/* @__PURE__ */ jsx(Code2, { className: "h-3.5 w-3.5 text-primary" }), /* @__PURE__ */ jsx("span", { children: "Raw HTML Code Mode — direct source code editing for advanced styling." })]
						...
						mode === "preview" && /* @__PURE__ */ jsxs("div", {
							className: "space-y-4",
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4" }), /* @__PURE__ */ jsx("span", { children: "Public Live Appearance Preview" })]
								}), /* @__PURE__ */ jsx("span", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("span", {
											...
											children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-3 w-3" }), "Legal & Privacy"]
										}),
										/* @__PURE__ */ jsx("h1", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("span", { children: ["Public URL: ", /* @__PURE__ */ jsx("code", {
						className: "rounded bg-muted px-1.5 py-0.5 font-mono text-[11px] text-foreground",
						children: "/privacy"
					})] }), /* @__PURE__ */ jsx("span", { children: "Tip: Switch to Visual Editor for fast writing without coding." })]
				})
			]
		})]
	});

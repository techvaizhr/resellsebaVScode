...
import { R as initial_data_default, r as supabase, s as createSsrRpc } from "./client-CLBrUPi_.js";
import { l as stringType, s as objectType } from "./types-CX4iBvKD.js";
import { t as requireSupabaseAuth } from "./auth-middleware-CFRvnVDQ.js";
...
import { C as shouldThrowError, O as Subscribable, S as shallowEqualObjects, _ as noop, c as notifyManager, f as hashKey, n as useQueryClient } from "./QueryClientProvider-CF67hjzh.js";
import { n as getDefaultState } from "./mutation-BvEKk1Gl.js";
import { n as toast } from "./dist-D98gQi4U.js";
import { M as ShoppingCart, Nt as LoaderCircle, U as Search, r as X, tt as Plus, v as Trash2, yt as Minus } from "./vendor-icons-DF2A5Z8S.js";
import { o as useAdvancedSettings } from "./advanced-settings-DcGrD_1t.js";
...
import { i as courierLabel, n as CourierLogo } from "./courier-brand-CUjZM-4C.js";
...
import { a as MoneyField, i as AdvanceByToggle, n as packagingModeHint, o as SectionLabel, r as packagingTotal } from "./NewOrderModal-D3cq53fK.js";
...
var getOrderDetails = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).inputValidator((data) => objectType({ orderId: stringType() }).parse(data)).handler(createSsrRpc("9866f76328537afcd342bb1462aec6c6ae4b18546f6c8c8eb5b12fe84b9c6aa1"));
/**
...
*/
var recheckCourierStatus = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((data) => objectType({ orderId: stringType() }).parse(data)).handler(createSsrRpc("a87394ade9e07fcb6800ba5b6e57ae4c915ca4d0514b5da41cd7c28310de862c"));
//#endregion
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Block, {
					...
					children: [
						...
						discount > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row$1, {
							label: "Discount",
							value: `− ${bdt(discount)}`,
							tone: "danger"
						}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Block, {
					title: "Collection",
					children: [
						advance > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row$1, {
						...
						total > 0 && shortfall > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Block, {
					title: "Result",
					children: [heldByReseller > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row$1, {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			...
			children: [
				...
				advance != null && advance > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Chip, {
					label: "adv",
					value: bdt(advance),
...
function OrderEditModal({ orderId, allProducts, onClose, onSaved, isAdmin = false }) {
	...
	const [originalQty, setOriginalQty] = (0, import_react.useState)({});
	...
	const [paymentStatus, setPaymentStatus] = (0, import_react.useState)("unpaid");
	const [note, setNote] = (0, import_react.useState)("");
	/** Delivery charge override — "" means use the product default for the picked area. */
	const [shipInput, setShipInput] = (0, import_react.useState)("");
	/** True once the user types a custom delivery charge; auto value follows the area otherwise. */
	const [shipTouched, setShipTouched] = (0, import_react.useState)(false);
	/** Order level adjustments — "" means keep the default value. */
	const [discount, setDiscount] = (0, import_react.useState)("");
	const [packagingInput, setPackagingInput] = (0, import_react.useState)("");
	const [deliveryCostInput, setDeliveryCostInput] = (0, import_react.useState)("");
	const [deliveryCostTouched, setDeliveryCostTouched] = (0, import_react.useState)(false);
	...
	const lineProducts = (0, import_react.useMemo)(() => items.map((it) => effectiveProducts.find((x) => x.id === it.product_id)).filter(Boolean), [items, effectiveProducts]);
	/** Highest product delivery charge for the selected area wins. */
	const autoShipping = (0, import_react.useMemo)(() => lineProducts.reduce((max, p) => Math.max(max, productDeliveryCharge(p, area)), 0), [lineProducts, area]);
	/** Area picker only matters when charges actually vary by area (same rule as the Add Order modal). */
	const showAreaPicker = (0, import_react.useMemo)(() => {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: areaOptions().map(({ value: v, label }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													...
													children: label
												}), showAreaPicker && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										...
										!shipTouched && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									(query.trim() !== "" || showDropdown) && results.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: query ? `Search Results (${results.length})` : `Available Products (${results.length})` }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												type: "button",
												onClick: () => {
										...
										}), results.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											type: "button",
											onClick: () => {
												addProduct(p);
												setShowDropdown(false);
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													...
													}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingCart, { className: "m-2 h-5 w-5 text-muted-foreground/40" })
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												children: it.product_image ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
													src: it.product_image,
													alt: "",
													className: "h-full w-full object-cover"
												}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingCart, { className: "m-2.5 h-5 w-5 text-muted-foreground/40" })
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Payable total" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["৳", totals.total.toFixed(0)] })]
										})
									] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											totals.advance > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Received (incl. advance)" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["৳", totals.received.toFixed(0)] })]
											}),
											totals.shortfall > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "mt-1 flex justify-between text-[11px] font-semibold text-destructive",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Not received" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["−৳", totals.shortfall.toFixed(0)] })]
											})
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "mt-1 flex justify-between border-t pt-1 text-[13px] font-bold text-foreground",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Total cost" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["৳", (totals.productCost + totals.deliveryCost + totals.packaging).toFixed(0)] })]
											})
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: totals.grossProfit < 0 ? isAdmin ? "Reseller loss" : "Your loss" : isAdmin ? "Reseller profit" : "Your profit" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["৳", totals.grossProfit.toFixed(0)] })]
											}),
											totals.resellerAdvance > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Final amount to receive" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			...
			children: events.map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: new Date(e.event_at).toLocaleString() }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "·" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CourierLogo, {
								provider: e.provider,
								size: 13
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: courierLabel(e.provider) }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["· ", e.source] }),
							e.notification_type ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["· ", e.notification_type] }) : null
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-0.5 flex flex-wrap gap-1.5 text-[11px] text-muted-foreground",
						children: [
							e.tracking_code && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Tracking ", e.tracking_code] }),
							e.cod_amount != null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["COD ৳", Number(e.cod_amount).toFixed(0)] }),
							e.delivery_charge != null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Charge ৳", Number(e.delivery_charge).toFixed(0)] })
						]
					}),
...
//#endregion
export { AdvanceChip as a, recheckCourierStatus as c, ResellerTotalCell as i, useMutation as l, OrderEditModal as n, OrderMoneyPanel as o, AdminTotalCell as r, getOrderDetails as s, CourierTimeline as t };

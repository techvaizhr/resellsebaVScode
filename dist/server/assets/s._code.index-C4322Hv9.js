import { t as Route } from "./s._code.index-BOo52qfw.js";
import { a as PrimaryButton, c as borderc, d as useStore, l as cx, n as GhostButton, o as ProductGrid, r as Heading, s as SectionHead, t as EmptyState, u as muted } from "./ui-BKy6cVLc.js";
...
function Hero() {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("span", {
					...
					children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4" }), " 🔥 আজকের সেরা অফার — স্টক শেষ হওয়ার আগেই অর্ডার করুন!"]
				}), /* @__PURE__ */ jsx("span", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("span", {
								...
								children: [/* @__PURE__ */ jsx(Truck, { className: "h-3 w-3" }), " দ্রুততম ডেলিভারি"]
							})]
						}),
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("span", {
								className: "flex items-center gap-1.5",
								children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4 text-emerald-600" }), " পণ্য দেখে মূল্য পরিশোধ"]
							}), /* @__PURE__ */ jsxs("span", {
								className: "flex items-center gap-1.5",
								children: [/* @__PURE__ */ jsx(Truck, { className: "h-4 w-4 text-[var(--st-primary)]" }), " ২৪-৭২ ঘণ্টায় ডেলিভারি"]
							})]
						})
					]
				}), /* @__PURE__ */ jsx("div", {
	...
	if (theme.layout.hero === "spotlight") return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-[var(--st-bg)] via-[var(--st-bg)]/80 to-transparent" }),
			/* @__PURE__ */ jsxs("div", {
	...
	if (theme.layout.hero === "split") return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs("div", { children: [
			badge && /* @__PURE__ */ jsxs("span", {
				...
				children: [
					/* @__PURE__ */ jsx(Leaf, { className: "h-3.5 w-3.5 text-emerald-600" }),
					" ",
					badge
				]
			}),
...
function ThemeSignature({ slot = "mid" }) {
		...
		return /* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4 animate-pulse" }),
						" ",
						title
					]
				}), /* @__PURE__ */ jsxs("div", {
	...
	if (theme.id === "aurora") return /* @__PURE__ */ jsx("section", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(Truck, { className: "h-5 w-5" })
					}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
						className: "text-sm font-bold text-[var(--st-fg)]",
		...
		return /* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", { className: "mx-auto mt-6 h-px w-16 bg-[#d9c08a]/40" })
				]
			})
		});
	}

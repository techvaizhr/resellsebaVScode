...
import { H as Search, Jn as ChevronDown, Kn as ChevronRight, Ot as LogOut, St as Menu, Xt as House, _n as ExternalLink, dt as PanelLeftClose, r as X, ut as PanelLeftOpen } from "./vendor-icons-BWIzFOtW.js";
...
import { t as clearImpersonation } from "./impersonation-MaxYc9Ty.js";
import { t as PwaInstallButton } from "./pwa-install-BYm0VthH.js";
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LeftIcon, { className: "h-5 w-5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, { count: left.badge ?? 0 })]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RightIcon, { className: "h-5 w-5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, { count: right.badge ?? 0 })]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function AppShell({ title, brand, nav, user, headerRight, homeTo = "/dashboard", bottomNav, mobileFooterLinks, children }) {
	...
	const activeGroupIdx = (0, import_react.useMemo)(() => {
	...
	const [openIdx, setOpenIdx] = (0, import_react.useState)(activeGroupIdx);
	...
	const [desktopCollapsed, setDesktopCollapsed] = (0, import_react.useState)(() => {
	...
	const filteredNav = (0, import_react.useMemo)(() => {
	...
	const renderSidebar = (collapsed, isMobile = false) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [brand.logoUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: brand.name
						}), brand.sub && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "truncate text-[11px] font-medium text-muted-foreground uppercase tracking-wider",
							children: brand.sub
						})]
					})]
				}), !collapsed && isMobile && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
			...
			!collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "absolute left-2.5 h-3.5 w-3.5 text-muted-foreground pointer-events-none" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
				...
				children: filteredNav.map((entry, idx) => {
					if (!isGroup(entry)) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LeafLink, {
						item: entry,
						collapsed
					}, entry.to);
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: cn("h-3.5 w-3.5 transition-transform duration-200", hasActive ? "text-primary" : "text-muted-foreground/70", isOpen ? "rotate-0" : "-rotate-90") })
							]
						}), isOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-0.5 ml-3 border-l-2 border-primary/20 pl-2 space-y-0.5 py-0.5",
							children: entry.items.map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LeafLink, {
								item: it,
								nested: true,
								collapsed: false
							}, it.to))
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					isMobile && !collapsed && mobileFooterLinks && mobileFooterLinks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mb-2 space-y-1 border-b border-border/40 pb-2",
						children: mobileFooterLinks.map((l) => l.external ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							href: l.to,
							target: "_blank",
							rel: "noreferrer",
							onClick: () => setMobileOpen(false),
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "h-3.5 w-3.5 opacity-40" })
							]
					...
					!collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ResellerAvatar, {
								...
								name: user.name,
								size: 34
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute bottom-0 right-0 h-2.5 w-2.5 rounded-full bg-emerald-500 ring-2 ring-card" })]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "min-w-0 flex-1",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: desktopCollapsed ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PanelLeftOpen, { className: "h-4 w-4" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PanelLeftClose, { className: "h-4 w-4" })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: homeTo,
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PwaInstallButton, {}), headerRight]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		}), bottomNav && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BottomNav, {
...
function LeafLink({ item, nested = false, collapsed = false }) {
	if (item.external) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
		href: item.to,
		target: "_blank",
		rel: "noreferrer",
		title: item.label,
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			children: item.icon
		}), collapsed ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "flex-1 truncate",
			children: item.label
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "h-3 w-3 opacity-40 group-hover:opacity-80 transition-opacity" })] })]
	});
	if (collapsed) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		...
		children: [item.icon, !!item.badge && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "h-3 w-3 opacity-0 group-hover:opacity-70 transition-opacity" })
		]
	});
}
//#endregion

...
import { Kn as ChevronRight, bn as EllipsisVertical, qn as ChevronLeft, yn as Ellipsis } from "./vendor-icons-BWIzFOtW.js";
import { n as DropdownMenuContent, o as DropdownMenuTrigger, t as DropdownMenu } from "./dropdown-menu-7F50lnQ7.js";
...
function DataToolbar({ search, onSearch, searchPlaceholder = "Search…", filters = [], perPage, onPerPage, perPageOptions = [
	...
	const searchInput = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
		value: search,
	...
	const perPageSelect = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
		value: perPage,
		onChange: (e) => onPerPage(Number(e.target.value)),
		className: "shrink-0 rounded-md border bg-background px-2 py-2 text-sm outline-none focus:ring-2 focus:ring-ring",
		title: "Per page",
		children: [perPageOptions.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", {
			value: n,
			children: [n, " / page"]
	...
	const filterSelects = filters.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
		value: f.value,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [searchInput, /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex shrink-0 items-center gap-2",
				children: [perPageSelect, right]
			})]
		}), filters.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function Pagination({ page, perPage, total, onPage }) {
	...
	const [goTo, setGoTo] = (0, import_react.useState)("");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		...
		}), !showAll && pages > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, { className: "h-3 w-3" })
				}),
				pageWindow(current, pages).map((p, i) => p === "…" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function ActionMenu({ children, vertical = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			title: "Actions",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(vertical ? EllipsisVertical : Ellipsis, { className: "h-4 w-4" })
		})

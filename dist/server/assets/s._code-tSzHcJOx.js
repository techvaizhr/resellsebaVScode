import { t as Route } from "./s._code-wjMLxAyp.js";
import { c as borderc, d as useStore, f as useStoreLoader, l as cx, r as Heading, u as muted } from "./ui-BKy6cVLc.js";
import { l as storeThemeStyle } from "./store-content-uAaIXYBj.js";
import { i as menuTarget } from "./store-menu-K9arh0xV.js";
import { n as PwaInstallButton } from "./pwa-install-DR9vFvGO.js";
import { i as useStoreVisitLog } from "./store-visits-KJ8yS9Ko.js";
import { useState } from "react";
import { Link, Outlet, useNavigate, useRouterState } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ChevronDown, Loader2, Menu, MessageCircle, Phone, Search, ShoppingBag, X } from "lucide-react";
...
function StoreHeader() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [bannerText && /* @__PURE__ */ jsx("div", {
		...
		children: [wa && /* @__PURE__ */ jsxs("a", {
			...
			children: [
				/* @__PURE__ */ jsxs("span", {
					...
					children: [/* @__PURE__ */ jsx("span", { className: "absolute inline-flex h-full w-full animate-ping rounded-full bg-white opacity-75" }), /* @__PURE__ */ jsx("span", { className: "relative inline-flex h-2.5 w-2.5 rounded-full bg-white" })]
				}),
				/* @__PURE__ */ jsx(MessageCircle, { className: "h-4 w-4 fill-white" }),
				/* @__PURE__ */ jsx("span", { children: "হোয়াটসঅ্যাপে অর্ডার" })
			]
		}), phone && /* @__PURE__ */ jsxs("a", {
			href: `tel:${phone}`,
			...
			children: [/* @__PURE__ */ jsx(Phone, { className: "h-4 w-4 fill-current" }), /* @__PURE__ */ jsx("span", { children: "কল করুন" })]
		})]
	});
}
//#endregion
	...
	return /* @__PURE__ */ jsx(Provider, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(FloatingQuickOrder, {})
			]
		})
	});
}

...
import { t as GATEWAYS } from "./registry-I6SFzk_W.js";
import { n as toast } from "./dist-D98gQi4U.js";
import { Bn as CircleX, Kn as CircleCheck, Mt as LoaderCircle, bn as EyeOff, t as Zap, tt as Plug, xn as ExternalLink, yn as Eye, z as Settings2 } from "./vendor-icons-BEaCFqaT.js";
import { a as testGatewayConnection } from "./gateways.functions-Clkb-tJL.js";
...
function Switch({ checked, onChange, label }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute top-0.5 h-5 w-5 rounded-full bg-background shadow transition-all " + (checked ? "left-[22px]" : "left-0.5") })
	});
}
function SecretInput({ value, onChange, placeholder, secret, multiline }) {
	const [show, setShow] = import_react.useState(false);
	if (multiline) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "relative",
		...
		}), secret && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			type: "button",
			onClick: () => setShow((s) => !s),
...
function GatewayGrid({ onCountChange, resellerId = null, platformActive }) {
	...
	const active = (0, import_react.useMemo)(() => Object.values(rows).filter((r) => r.is_active).length, [rows]);
	(0, import_react.useEffect)(() => onCountChange?.(active), [active, onCountChange]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: isReseller ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					"For every gateway you choose the source: ",
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Platform gateway" }),
					" means the money goes to the platform account the admin already configured, and ",
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "My own credentials" }),
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: paymentLogo(spec.provider) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaymentLogo, {
											method: spec.provider,
											width: 96,
											height: 44,
											fit: "cover",
											alt: `${spec.label} logo`
										}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Zap, { className: "h-5 w-5 text-muted-foreground" })
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: [
												...
												isReseller ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: platformOff ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-amber-600 dark:text-amber-400",
									children: "Not enabled by the platform"
								}) : row.mode === "platform" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-success",
									children: "Uses the platform account"
								}) : missing.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "text-amber-600 dark:text-amber-400",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Settings2, { className: "h-3.5 w-3.5" }), " Configure"]
								}), spec.docs && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
									href: spec.docs,
									target: "_blank",
									rel: "noreferrer",
			...
			editing && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GatewayModal, {
...
function GatewayModal({ spec, row: initial, resellerId, platformActive, onClose, onSaved }) {
	const [row, setRow] = (0, import_react.useState)(initial);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppModal, {
		title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaymentLogo, {
				method: spec.provider,
				size: 24
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: spec.label })]
		}),
		...
		footer: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [testing ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plug, { className: "h-3.5 w-3.5" }), " Test connection"]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				resellerId && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "sm:col-span-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Money goes to" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Display label" }), (row.label ?? "") !== spec.label && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => setRow({
							...row,
							label: spec.label
				...
				row.mode === "own" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "API base URL" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
				...
				row.mode === "own" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "sm:col-span-2 mt-1 text-[11px] font-semibold",
					children: "Credentials"
				}), spec.fields.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SecretInput, {
				...
				result && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [result.ok ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "mt-0.5 h-3.5 w-3.5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleX, { className: "mt-0.5 h-3.5 w-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: result.message })]
				})
			]
		})
	});

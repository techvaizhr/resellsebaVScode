import { O as formatDateTime } from "./client-CdRSQB5v.js";
		...
		/* @__PURE__ */ jsx("ol", {
			...
			children: ledger.map((e, i) => {
				...
				return /* @__PURE__ */ jsxs("li", {
					className: "relative",
					children: [/* @__PURE__ */ jsx("span", { className: "absolute -left-[26px] top-1.5 h-3 w-3 rounded-full ring-4 ring-background " + (voided ? "bg-muted-foreground/40" : inflow ? "bg-success" : "bg-destructive") }), /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								e.reference && e.reference !== "—" && /* @__PURE__ */ jsx("div", {

import { D as formatDate } from "./client-BpJCBCUq.js";
...
import { AlertTriangle, ArrowUpRight, Copy, ExternalLink, IdCard, Lock, Mail, MailCheck, MailX, MapPin, Phone, ShieldCheck, Smartphone, SmartphoneNfc } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("span", {
		...
		children: [
			/* @__PURE__ */ jsx(Chip, {
				...
				label: "Email",
				icon: /* @__PURE__ */ jsx(MailCheck, { className: "h-3 w-3" }),
				iconOff: /* @__PURE__ */ jsx(MailX, { className: "h-3 w-3" })
			}),
			hasPhone ? /* @__PURE__ */ jsx(Chip, {
				verified: phoneVerified,
				required: requirePhone,
				label: "Mobile",
				icon: /* @__PURE__ */ jsx(SmartphoneNfc, { className: "h-3 w-3" }),
				iconOff: /* @__PURE__ */ jsx(Smartphone, { className: "h-3 w-3" })
			}) : /* @__PURE__ */ jsxs("span", {
				className: `${base} ${offCls}`,
				title: "No phone number saved",
				children: [/* @__PURE__ */ jsx(Smartphone, { className: "h-3 w-3" }), " No mobile"]
			}),
			emailVerified && (phoneVerified || !hasPhone) && /* @__PURE__ */ jsxs("span", {
				className: `${base} ${okCls}`,
				title: "Every verification step is done",
				children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-3 w-3" }), " Fully verified"]
			})
		]
	});
}
...
function Stat({ label, value, tone, to, search }) {
	const body = /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: label
		}), to && /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-3 w-3 shrink-0 text-muted-foreground opacity-0 transition group-hover:opacity-100" })]
	}), /* @__PURE__ */ jsx("div", {
					...
					children: [/* @__PURE__ */ jsx(ResellerAvatar, {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								r.email_verified != null && /* @__PURE__ */ jsx(VerifyBadges, {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsx(IdCard, { className: "h-4 w-4 text-primary" }),
										/* @__PURE__ */ jsx("span", {
											className: "text-[10px] uppercase tracking-wide text-muted-foreground",
								...
								/* @__PURE__ */ jsxs("a", {
									...
									children: [/* @__PURE__ */ jsx(ExternalLink, { className: "h-4 w-4" }), " Visit store"]
								}),
								/* @__PURE__ */ jsx(IconBtn, {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [depositActive ? depositDue > 0 ? /* @__PURE__ */ jsxs("span", {
							...
							children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-3 w-3" }), " Deposit complete"]
						}) : /* @__PURE__ */ jsxs("span", {
							className: "inline-flex items-center gap-1 rounded-full bg-muted px-2 py-0.5 text-[11px] font-medium text-muted-foreground",
							children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-3 w-3" }), " No security deposit required"]
						}), Number(r.frozen_amount ?? 0) > 0 && /* @__PURE__ */ jsxs("span", {
							className: "inline-flex items-center gap-1 rounded-full bg-muted px-2 py-0.5 text-[11px] font-medium text-muted-foreground",
							children: [
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx(Row, {
							...
							action: r.email ? /* @__PURE__ */ jsx(IconBtn, {
								title: "Copy email",
						...
						/* @__PURE__ */ jsx(Row, {
							...
							action: r.contact_phone ? /* @__PURE__ */ jsx(IconBtn, {
								title: "Copy phone",
						...
						/* @__PURE__ */ jsx(Row, {
							...
							value: /* @__PURE__ */ jsxs("span", {
								...
								children: [
									/* @__PURE__ */ jsx(MapPin, { className: "mt-0.5 h-3.5 w-3.5 shrink-0 text-muted-foreground" }),
									" ",
									r.address ?? "—"
								]
							})
						}),
						r.nid_number !== void 0 && /* @__PURE__ */ jsx(Row, {
							label: "NID",
							value: r.nid_number ?? "—"
						}),
						/* @__PURE__ */ jsx(Row, {
						...
						r.leader_name !== void 0 && /* @__PURE__ */ jsx(Row, {
							label: "Leader",
							value: r.leader_name ?? "No leader"
						}),
						r.agent_name !== void 0 && /* @__PURE__ */ jsx(Row, {
							label: "Commission agent",
							value: r.agent_name ?? "No agent assigned"
						}),
						/* @__PURE__ */ jsx(Row, {
							label: "Status",
							value: /* @__PURE__ */ jsx("span", { children: resellerStatusLabel(r.status) })
						}),
						/* @__PURE__ */ jsx(Row, {
					...
					children: [/* @__PURE__ */ jsx("h3", {
					...
					}), r.payout_method ? /* @__PURE__ */ jsxs(Fragment, { children: [
						/* @__PURE__ */ jsx(Row, {
							label: "Method",
							value: /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsx(Row, {
							...
							action: r.payout_account_number ? /* @__PURE__ */ jsx(IconBtn, {
						...
						r.payout_method === "bank" && /* @__PURE__ */ jsxs(Fragment, { children: [
							/* @__PURE__ */ jsx(Row, {
								label: "Bank",

...
import { Mt as LoaderCircle, Zn as ChartLine, mn as Facebook, t as Zap } from "./vendor-icons-BWIzFOtW.js";
import { n as PageHeader } from "./ui-kit-QFWJ0cl0.js";
//#region src/routes/_authenticated/admin/marketing.tsx?tsr-split=component
...
function MarketingPage() {
	...
	async function load() {
		...
		setRows(DEFAULTS.map((d) => {
			const found = map.get(d.platform);
			return found ? {
				id: found.id,
				platform: d.platform,
				...
				test_event_code: found.test_event_code ?? ""
			} : d;
		}));
		setLoading(false);
	}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
		title: "Marketing & ads",
		description: "Pixel and Events API defaults. Resellers can override per store."

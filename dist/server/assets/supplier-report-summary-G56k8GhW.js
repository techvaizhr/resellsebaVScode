...
import { ArrowRight, Boxes, Coins, Hourglass, Info, PackageCheck, Search, Undo2, Wallet } from "lucide-react";
...
function SupplierMoneyFlow({ totals }) {
	...
	const steps = [
		...
		},
		{
			...
			icon: /* @__PURE__ */ jsx(Hourglass, { className: "h-4 w-4" })
		},
		{
			key: "returned",
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Coins, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("h3", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Info, { className: "h-3.5 w-3.5" }), "Every line uses the price saved at order time, so later price changes never rewrite old sales."]
				})
			]
		}), /* @__PURE__ */ jsxs("div", {
			className: "surface-card overflow-hidden p-0",
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					className: "divide-y",
					children: ledger.map((l) => /* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" }), " Payable now"]
					}), /* @__PURE__ */ jsx("span", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("tbody", {
						className: "divide-y",
						children: rows.map((p) => /* @__PURE__ */ jsxs("tr", {

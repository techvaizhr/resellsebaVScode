...
import { I as DEFAULT_LANDING_CONTENT, L as mergeLandingContent, r as supabase } from "./client-CLBrUPi_.js";
import { n as toast } from "./dist-D98gQi4U.js";
import { Ct as Menu, D as Sparkles, Jt as Image, K as Save, Nt as LoaderCircle, Sn as ExternalLink, Un as CircleQuestionMark, Ut as Layers, q as RotateCcw, tt as Plus, v as Trash2 } from "./vendor-icons-DF2A5Z8S.js";
import { t as clearAppDataCache } from "./app-data-YK8UJDGT.js";
import { n as PageHeader } from "./ui-kit-QFWJ0cl0.js";
import { t as ImageUploader } from "./ImageUploader-9szC8bmi.js";
import { n as APP_ICON_NAMES } from "./icons-xPZ6GUZi.js";
...
function LandingEditor() {
	const [c, setC] = (0, import_react.useState)(DEFAULT_LANDING_CONTENT);
				...
				actions: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "h-3.5 w-3.5" }), " View Live Page"]
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [busy ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Save, { className: "h-4 w-4" }), "Save Landing Page"]
						})
					]
				})
			}),
				...
				children: [
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsList, {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsTrigger, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "h-3.5 w-3.5" }), " Hero Banner"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsTrigger, {
									value: "nav",
									className: "flex items-center gap-2 rounded-xl py-2 px-3 text-xs font-semibold data-[state=active]:bg-card data-[state=active]:text-primary data-[state=active]:shadow-sm transition-all",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Menu, { className: "h-3.5 w-3.5" }), " Navigation & Menu"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsTrigger, {
									value: "stats",
									className: "flex items-center gap-2 rounded-xl py-2 px-3 text-xs font-semibold data-[state=active]:bg-card data-[state=active]:text-primary data-[state=active]:shadow-sm transition-all",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layers, { className: "h-3.5 w-3.5" }), " Statistics"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsTrigger, {
									value: "features",
									className: "flex items-center gap-2 rounded-xl py-2 px-3 text-xs font-semibold data-[state=active]:bg-card data-[state=active]:text-primary data-[state=active]:shadow-sm transition-all",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "h-3.5 w-3.5" }), " Features Grid"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsTrigger, {
									value: "workflow",
									className: "flex items-center gap-2 rounded-xl py-2 px-3 text-xs font-semibold data-[state=active]:bg-card data-[state=active]:text-primary data-[state=active]:shadow-sm transition-all",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layers, { className: "h-3.5 w-3.5" }), " How It Works"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsTrigger, {
									value: "faq",
									className: "flex items-center gap-2 rounded-xl py-2 px-3 text-xs font-semibold data-[state=active]:bg-card data-[state=active]:text-primary data-[state=active]:shadow-sm transition-all",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleQuestionMark, { className: "h-3.5 w-3.5" }), " FAQs"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsTrigger, {
									value: "cta_footer",
									className: "flex items-center gap-2 rounded-xl py-2 px-3 text-xs font-semibold data-[state=active]:bg-card data-[state=active]:text-primary data-[state=active]:shadow-sm transition-all",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image, { className: "h-3.5 w-3.5" }), " CTA & Footer"]
								})
							]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Grid, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(F, {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
							...
							icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Menu, { className: "h-4 w-4 text-primary" }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
							...
							icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layers, { className: "h-4 w-4 text-primary" }),
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(F, {
								...
								className: "space-y-3",
								children: [(c.stats?.items ?? []).map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								}, i)), (c.stats?.items?.length ?? 0) < 6 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									type: "button",
									onClick: () => update((d) => {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-3.5 w-3.5 text-primary" }), " Add Stat Item"]
								})]
							})]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Grid, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(F, {
								label: "Section Title",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(I, {
								...
								children: [(c.features?.items ?? []).map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												...
												className: inp,
												children: ICONS.map((ic) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
													value: ic,
													children: ic
												}, ic))
											})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									className: "inline-flex items-center gap-1.5 rounded-xl border px-3.5 py-2 text-xs font-semibold hover:bg-muted transition-all",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-3.5 w-3.5 text-primary" }), " Add Feature Card"]
								})]
							})]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "space-y-3",
									children: [(c.about?.flow ?? []).map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "rounded-xl border border-border/80 bg-muted/20 p-3.5 space-y-3",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "flex items-center justify-between",
										...
										className: "inline-flex items-center gap-1.5 rounded-xl border px-3.5 py-2 text-xs font-semibold hover:bg-muted transition-all",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-3.5 w-3.5 text-primary" }), " Add Workflow Step"]
									})]
								})
							]
						})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
							...
							icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleQuestionMark, { className: "h-4 w-4 text-primary" }),
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Grid, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(F, {
								...
								children: [(c.faq?.items ?? []).map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-xl border border-border/80 bg-muted/20 p-3.5 space-y-3",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center justify-between",
									...
									className: "inline-flex items-center gap-1.5 rounded-xl border px-3.5 py-2 text-xs font-semibold hover:bg-muted transition-all",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-3.5 w-3.5 text-primary" }), " Add FAQ Item"]
								})]
							})]
						})
					}),

...
import { i as ResellerProductCalc } from "./price-breakdown-CGuNUtD0.js";
import { t as Hint } from "./Hint-Ph3d-VhV.js";
import { r as stripHtml, t as CopyButton } from "./reseller-tools-8ryd3dba.js";
...
function CatalogPage() {
	...
	const [listed, setListed] = useState(/* @__PURE__ */ new Set());
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsx(PageHeader, { title: "Catalog" }),
		/* @__PURE__ */ jsxs("div", {
			className: "-mt-4 mb-4 inline-flex items-center gap-1.5 text-xs text-muted-foreground",
			children: ["How are charges calculated?", /* @__PURE__ */ jsxs(Hint, {
				side: "bottom",
				children: [
					"Per order, admin deducts ",
					/* @__PURE__ */ jsx("b", { children: "(reseller price + packaging) × quantity" }),
		...
		filtered.length === 0 ? /* @__PURE__ */ jsx(EmptyState, {
			...
			picked.size > 0 && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("span", {
					...
					children: [
						/* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5" }), " List (suggested price)"]
						}),
						/* @__PURE__ */ jsxs("button", {
							disabled: bulkBusy,
							...
							children: [/* @__PURE__ */ jsx(Trash2, { className: "h-3.5 w-3.5" }), " Delist"]
						}),
						/* @__PURE__ */ jsx("button", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("button", {
					...
					children: [paged.length > 0 && paged.every((p) => picked.has(p.id)) ? /* @__PURE__ */ jsx(CheckSquare, { className: "h-3.5 w-3.5 text-primary" }) : /* @__PURE__ */ jsx(Square, { className: "h-3.5 w-3.5" }), "Select page"]
				})
			}),
			/* @__PURE__ */ jsx("div", {
					...
					return /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("button", {
								...
								"aria-label": "Select",
								children: isPicked ? /* @__PURE__ */ jsx(CheckSquare, { className: "h-4 w-4 text-primary" }) : /* @__PURE__ */ jsx(Square, { className: "h-4 w-4" })
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "relative",
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx(ImagePickerButton, {
										baseName: p.name,
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											p.packaging_cost,
											" = ",
											/* @__PURE__ */ jsxs("b", { children: ["৳", myCost] }),
											" (your cost)"
										]
									}),
									/* @__PURE__ */ jsxs("div", {
									...
									isListed ? /* @__PURE__ */ jsxs("button", {
										...
										children: [/* @__PURE__ */ jsx(Trash2, { className: "h-3 w-3" }), " Delist"]
									}) : /* @__PURE__ */ jsxs("button", {
										onClick: () => openList(p),
										...
										children: [/* @__PURE__ */ jsx(Plus, { className: "h-3 w-3" }), " List in my store"]
									})
								]
							})
						]
		...
		selected && /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("label", {
							...
							children: [
								...
								minSell,
								")",
								/* @__PURE__ */ jsx(Hint, { children: "Customer pays this for the product; delivery is added on top." })
							]
						}), /* @__PURE__ */ jsx("input", {
							type: "number",
							min: minSell,
					...
					/* @__PURE__ */ jsxs("div", {
						className: "mt-4",
						children: [/* @__PURE__ */ jsx(ResellerProductCalc, { input: {
							buying: 0,
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("button", {
							...
							children: [busy && /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), " Add to my store"]
						}), /* @__PURE__ */ jsx("button", {
							onClick: () => setSelected(null),
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									adv.resellerCatalogShowStock && /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
										className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground",
										children: "Stock"
									}), /* @__PURE__ */ jsxs("div", {

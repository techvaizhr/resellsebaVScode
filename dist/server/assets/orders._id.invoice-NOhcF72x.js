...
import { t as Route } from "./orders._id.invoice-KlCcPW9I.js";
...
function InvoicePage() {
	...
	if (!order || !store) return /* @__PURE__ */ jsx("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [store.settings?.logo_url ? /* @__PURE__ */ jsx("img", {
						...
						store.settings?.tagline && /* @__PURE__ */ jsx("div", {
							className: "text-xs text-slate-500",
							children: store.settings.tagline
						}),
						store.settings?.whatsapp && /* @__PURE__ */ jsxs("div", {
							className: "text-xs text-slate-500",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsx("div", { children: order.customer_phone }),
					/* @__PURE__ */ jsx("div", {
						className: "text-slate-600",
						children: order.address_line
					}),
					order.city && /* @__PURE__ */ jsx("div", {
						className: "text-slate-600",
						children: order.city
					}),
					/* @__PURE__ */ jsx("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("tfoot", {
						...
						children: [
							...
							Number(order.discount) > 0 && /* @__PURE__ */ jsxs("tr", { children: [/* @__PURE__ */ jsx("td", {
								colSpan: 3,
								className: "p-2 text-right text-slate-500",
								children: "Discount"
							}), /* @__PURE__ */ jsxs("td", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(Printer, { className: "h-4 w-4" }), " Print / Save PDF"]
				})
			})
		]
	});

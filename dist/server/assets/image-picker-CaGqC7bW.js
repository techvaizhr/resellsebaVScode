...
function ImagePickerButton({ images, loadImages, baseName, className, compact }) {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("button", {
		...
		children: [loading ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ jsx(Download, { className: "h-3.5 w-3.5" }), compact ? null : "Image"]
	}), open && /* @__PURE__ */ jsx(ImagePickerModal, {
		images: list,
		baseName,
...
function ImagePickerModal({ images, baseName, onClose }) {
	const [sel, setSel] = useState(new Set(images.map((_, i) => i)));
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Download, { className: "h-4 w-4" }),
							"Download (",
							sel.size,
							")"
						]

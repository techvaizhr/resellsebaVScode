...
import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-CC0P_ZVh.js";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BsngUj2u.js");
...
async function handleServerRoutes({ getRouter, request, url, executeRouter, context, executedRequestMiddlewares }) {
	...
	const _matchedRes = router.getMatchedRoutes(pathname);

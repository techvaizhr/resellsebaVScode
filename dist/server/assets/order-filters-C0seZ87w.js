...
function OrderFilterBar({ value, onChange, resellerOptions, total, shown, right, showPerPage = false, hideSearch = false, variant = "default", trailing }) {
	...
	const dirty = useMemo(() => activeFilterCount(value) > 0 || !hideSearch && value.q !== "", [value, hideSearch]);
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							resellerOptions && /* @__PURE__ */ jsx(SearchableSelect, {
								label: "Reseller",
							...
							/* @__PURE__ */ jsx(Select, {
								...
								children: SORT_OPTIONS.map((o) => /* @__PURE__ */ jsx("option", {
									value: o.value,
									children: o.label
								}, o.value))
							}),
							trailing,
							showPerPage && /* @__PURE__ */ jsxs(Select, {
								label: "Per page",
			...
			value.datePreset === "custom" && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("label", {
					...
					children: [/* @__PURE__ */ jsxs("span", {
						className: "inline-flex items-center gap-1 text-[11px] font-medium text-muted-foreground",
						children: [/* @__PURE__ */ jsx(CalendarDays, { className: "h-3 w-3" }), " To"]
					}), /* @__PURE__ */ jsx("input", {
						type: "date",
						value: value.to,

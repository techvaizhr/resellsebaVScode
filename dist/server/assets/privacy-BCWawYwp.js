...
import { ArrowLeft, Calendar, CheckCircle2, Lock, Mail, Phone, Printer, ShieldCheck, Sparkles } from "lucide-react";
...
function PrivacyPage() {
	...
	const [contactEmail, setContactEmail] = useState("support@resellseba.com");
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "h-4 w-4" }), /* @__PURE__ */ jsx("span", { children: "Back to Home" })]
						}), /* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(Printer, { className: "h-3.5 w-3.5 text-muted-foreground" }), /* @__PURE__ */ jsx("span", { children: "Print Document" })]
							})
						})]
					}), /* @__PURE__ */ jsxs("div", {
						className: "max-w-2xl",
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: "Trust & Security" })]
							}),
							/* @__PURE__ */ jsx("h1", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("span", {
									...
									children: [/* @__PURE__ */ jsx(Calendar, { className: "h-3.5 w-3.5 text-primary" }), /* @__PURE__ */ jsx("span", { children: "Last Updated: March 2026" })]
								}), /* @__PURE__ */ jsxs("span", {
									className: "inline-flex items-center gap-1.5",
									children: [/* @__PURE__ */ jsx(Lock, { className: "h-3.5 w-3.5 text-emerald-500" }), /* @__PURE__ */ jsx("span", { children: "SSL Encrypted & Safe" })]
								})]
							})
						]
					})]
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("span", { children: "Our Privacy Commitments" })]
								}), /* @__PURE__ */ jsxs("ul", {
									className: "space-y-3 text-xs text-muted-foreground",
									children: [
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-start gap-2",
											children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-emerald-500 shrink-0 mt-0.5" }), /* @__PURE__ */ jsxs("span", { children: [/* @__PURE__ */ jsx("strong", { children: "Zero Data Selling:" }), " We never sell your personal data to marketing brokers."] })]
										}),
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-start gap-2",
											children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-emerald-500 shrink-0 mt-0.5" }), /* @__PURE__ */ jsxs("span", { children: [/* @__PURE__ */ jsx("strong", { children: "Encrypted Transactions:" }), " Financial and payout credentials are cryptographically protected."] })]
										}),
										/* @__PURE__ */ jsxs("li", {
											className: "flex items-start gap-2",
											children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-emerald-500 shrink-0 mt-0.5" }), /* @__PURE__ */ jsxs("span", { children: [/* @__PURE__ */ jsx("strong", { children: "Verified Logistics:" }), " Delivery addresses are shared solely for courier dispatch."] })]
										})
									]
								})]
							}),
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [contactEmail && /* @__PURE__ */ jsxs("a", {
											...
											children: [/* @__PURE__ */ jsx(Mail, { className: "h-3.5 w-3.5 text-primary" }), /* @__PURE__ */ jsx("span", {
												className: "truncate",
												children: contactEmail
											})]
										}), contactPhone && /* @__PURE__ */ jsxs("a", {
											href: `tel:${contactPhone}`,
											className: "flex items-center gap-2 rounded-xl border border-border/60 bg-background px-3 py-2 text-muted-foreground hover:text-primary hover:border-primary/40 transition-colors font-medium",
											children: [/* @__PURE__ */ jsx(Phone, { className: "h-3.5 w-3.5 text-emerald-500" }), /* @__PURE__ */ jsx("span", { children: contactPhone })]
										})]
									})
								]
							}),
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", { children: tagline }),
									/* @__PURE__ */ jsx("div", { children: "Operated under official platform governance standards." })
								]
							})
						]
					})]

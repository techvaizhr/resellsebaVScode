...
import { E as statusLabel, S as savePlan, T as statusClass, _ as fmtDate, g as fetchSubscriptionOverview, m as cycleLabel, p as CYCLES, w as setResellerSubscription, x as reviewSubscriptionPayment, y as planPrice } from "./client-DdbbmuGT.js";
import { n as toast } from "./dist-D98gQi4U.js";
import { Mt as LoaderCircle, Sn as Download, Yn as Check, a as Wallet, c as Users, dr as BadgeCheck, et as Plus, jn as Clock, ot as Pencil, r as X } from "./vendor-icons-BWIzFOtW.js";
...
import { i as usePaginated, r as Pagination } from "./data-list-CbGEMtW0.js";
...
function AdminSubscriptionsPage() {
	...
	const [tab, setTab] = (0, import_react.useState)("subscribers");
	const [data, setData] = (0, import_react.useState)(null);
	const [loading, setLoading] = (0, import_react.useState)(true);
	const [editPlan, setEditPlan] = (0, import_react.useState)(null);
	const [editSub, setEditSub] = (0, import_react.useState)(null);
	async function load() {
		try {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			tab === "subscribers" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SubscribersTab, {
				rows: subscribers,
				plans,
				canManage,
				onEdit: setEditSub
				...
				canManage,
				onEdit: setEditPlan
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RevenueTab, { rows: paid }),
			editPlan ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PlanModal, {
				plan: editPlan,
			...
			editSub ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SubscriberModal, {
				row: editSub,
				plans,
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PerPage, {
						value: perPage,
						onChange: setPerPage
					})
				]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Ends" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Balance" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {})
					]
				}), pageRows.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [r.state?.plan_name ?? "—", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: canManage ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							type: "button",
							onClick: () => onEdit(r),
							className: "inline-flex items-center gap-1 rounded-md border px-2 py-1 text-[11px] font-medium hover:bg-muted",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pencil, { className: "h-3 w-3" }), " Manage"]
...
function PaymentsTab({ rows, canManage, onReload }) {
	...
	(0, import_react.useEffect)(() => setPage(1), [q, perPage]);
	const pageRows = usePaginated(filtered, page, perPage);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				}), pageRows.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: p.status === "pending" && canManage ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								type: "button",
								disabled: busy === p.id,
...
function PlansTab({ plans, canManage, onEdit }) {
	const [page, setPage] = (0, import_react.useState)(1);
	const [perPage, setPerPage] = (0, import_react.useState)(20);
	(0, import_react.useEffect)(() => setPage(1), [perPage]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [canManage ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					type: "button",
					onClick: () => onEdit({
				...
				}) : null, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PerPage, {
					value: perPage,
					onChange: setPerPage
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: pagePlans.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
								...
								children: [p.name, p.is_default ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: CYCLES.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function RevenueTab({ rows }) {
	...
	if (byMonth.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "From earnings" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Wallet / bank" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Total" })
					]
				}), pageRows.map(([m, v]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function PlanModal({ plan, onClose, onSaved }) {
	const [form, setForm] = (0, import_react.useState)({ ...plan });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppModal, {
		...
		footer: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				children: [busy ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-3.5 w-3.5 animate-spin" }) : null, " Save plan"]
			})]
		}),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function SubscriberModal({ row, plans, onClose, onSaved }) {
	...
	const [planId, setPlanId] = (0, import_react.useState)(sub.plan_id ?? row.state?.plan_id ?? plans[0]?.id ?? "");
	const [isExempt, setIsExempt] = (0, import_react.useState)(Boolean(sub.is_exempt));
	const [extendMonths, setExtendMonths] = (0, import_react.useState)(0);
	const [note, setNote] = (0, import_react.useState)(sub.admin_note ?? "");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppModal, {
		...
		footer: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				onClick: submit,
				className: "inline-flex items-center gap-1.5 rounded-md bg-primary px-3 py-1.5 text-xs font-semibold text-primary-foreground disabled:opacity-60",
				children: [busy ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-3.5 w-3.5 animate-spin" }) : null, " Save changes"]
			})]
		}),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "grid gap-3 sm:grid-cols-2",
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
						...
						}), CYCLES.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
							value: m,
							children: cycleLabel(m)
						}, m))]
					})

...
import { o as useAdvancedSettings } from "./advanced-settings-BZDyi7cH.js";
...
import { i as courierLabel, n as CourierLogo } from "./courier-brand-CD69-Gna.js";
...
import { a as MoneyField, i as AdvanceByToggle, n as packagingModeHint, o as SectionLabel, r as packagingTotal } from "./NewOrderModal-iQ0QzH7V.js";
...
function OrderEditModal({ orderId, allProducts, onClose, onSaved, isAdmin = false }) {
	...
	const effectiveProducts = (0, import_react.useMemo)(() => {
		return allProducts && allProducts.length > 0 ? allProducts : initialData.products || [];
	}, [allProducts]);

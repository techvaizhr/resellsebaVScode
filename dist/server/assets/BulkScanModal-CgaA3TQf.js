...
import { $n as Camera, Fn as CircleX, Mt as LoaderCircle, Vn as CircleCheck, W as ScanLine, er as CameraOff, o as VolumeX, r as X, s as Volume2 } from "./vendor-icons-BWIzFOtW.js";
...
function BulkScanModal({ mode: initialMode, onClose, resolve, apply, modes }) {
	...
	(0, import_react.useEffect)(() => {
		...
		async function start() {
			setCamError(null);
			try {
				const { BrowserMultiFormatReader } = await import("./esm-hVmWZ_DC.js");

...
import { Nt as LoaderCircle, r as X, st as Pencil, tt as Plus, v as Trash2 } from "./vendor-icons-DF2A5Z8S.js";
...
function BrandsPage() {
	...
	const [editLogo, setEditLogo] = (0, import_react.useState)([]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		canManage && open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
			onSubmit: create,
			...
			children: items.filter((b) => {
				...
				children: [
					...
					canManage ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `h-1.5 w-1.5 rounded-full ${b.is_active ? "bg-primary-foreground" : "bg-muted-foreground/60"}` }), b.is_active ? "Active" : "Hidden"]

import { D as formatDate, r as supabase } from "./client-BpJCBCUq.js";
import { t as useServerFn } from "./useServerFn-CrZF2pjq.js";
import { i as gatewayLabel } from "./registry-UF_sjTj7.js";
import { i as fetchDepositMethods, r as cfgString } from "./payment-methods-WbIUvXF2.js";
import { r as startDepositPayment } from "./gateways.functions-CXGwAmYF.js";
...
function DepositPayPanel({ resellerId, due, onSubmitted }) {
	...
	if (unified.length === 0) return /* @__PURE__ */ jsx("div", {
		...
		children: [
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("span", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: [/* @__PURE__ */ jsx("span", {
										...
										children: m.kind === "online" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Zap, { className: "h-3 w-3" }), " Automatic"] }) : "Manual"
									})]
								})]
							}), active && /* @__PURE__ */ jsx(BadgeCheck, { className: "h-4 w-4 shrink-0 text-primary" })]
						}), m.account && /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								m.accountType && /* @__PURE__ */ jsxs("span", { children: ["· ", m.accountType] })
							]
						})]
					}, m.id);
				})
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
						...
						inputMode: "decimal",
						placeholder: "5000"
					})] }), selected?.kind === "manual" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
						className: "mb-1 block text-xs font-medium",
					...
					children: selected?.kind === "manual" ? /* @__PURE__ */ jsxs("button", {
						type: "button",
						disabled: busy,
						...
						children: [busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ jsx(Send, { className: "h-3.5 w-3.5" }), " Submit deposit"]
					}) : /* @__PURE__ */ jsxs("button", {
						type: "button",
						disabled: busy,
						onClick: () => void payOnline(),
						className: "btn-brand inline-flex items-center gap-1.5 rounded-md px-4 py-2 text-xs font-semibold disabled:opacity-50",
						children: [busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ jsx(Zap, { className: "h-3.5 w-3.5" }), " Pay now"]
					})
				})]
			}),
			requests.length > 0 && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					className: "divide-y",
					children: requests.map((r) => /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("span", {
								className: "ml-auto",
								children: /* @__PURE__ */ jsx(StatusChip, { status: r.status })
							}),
							r.admin_note && /* @__PURE__ */ jsxs("div", {
...
function StatusChip({ status }) {
	const map = {
		pending: {
			...
			icon: /* @__PURE__ */ jsx(Clock, { className: "h-3 w-3" }),
			label: "Pending verification"
		},
		approved: {
			cls: "bg-success/15 text-success",
			icon: /* @__PURE__ */ jsx(BadgeCheck, { className: "h-3 w-3" }),
			label: "Approved"
		},
		rejected: {

...
import { i as getLpBootstrap } from "./bootstrap-DBQz0zB2.js";
import { n as mergeLandingContent, r as APP_ICONS, t as DEFAULT_LANDING_CONTENT } from "./landing-content-nloeF7IX.js";
import { n as PwaInstallButton, t as PwaFooterOption } from "./pwa-install-DR9vFvGO.js";
import { n as PublicHeader, t as Brand } from "./public-header-C0ZZ0-VN.js";
import * as React from "react";
import { useEffect, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, Boxes, Check, ChevronDown, HelpCircle, Layers, ShoppingBag, Sparkles, Users } from "lucide-react";
...
function CountUp({ value, duration = 1400 }) {
	...
	if (target === null) return /* @__PURE__ */ jsx("span", {
		ref,
		children: value
	});
...
function RootResolver() {
	...
	if (checking) return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx("div", { className: "h-8 w-8 animate-pulse rounded-full bg-primary/20" })
	});
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 -z-10 bg-[image:var(--gradient-hero)]" }),
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -top-40 -left-32 -z-10 h-96 w-96 rounded-full bg-primary/25 blur-3xl animate-blob-drift" }),
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -bottom-40 -right-24 -z-10 h-96 w-96 rounded-full bg-accent/25 blur-3xl animate-blob-drift-slow" }),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 shrink-0" }), /* @__PURE__ */ jsx("span", {
										className: "truncate",
								...
								c.hero.badges.length > 0 && /* @__PURE__ */ jsx("div", {
									...
									children: c.hero.badges.map((b) => /* @__PURE__ */ jsxs("span", {
										className: "inline-flex items-center gap-1.5 rounded-full border border-primary/20 bg-primary/5 px-3 py-1.5",
										children: [
											/* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5 shrink-0 text-primary" }),
											" ",
											b
										]
									}, b))
							...
							children: [/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -inset-6 -z-10 rounded-[2rem] bg-[image:var(--gradient-brand)] opacity-20 blur-2xl" }), /* @__PURE__ */ jsxs("div", {
								className: "animate-float relative overflow-hidden rounded-2xl shadow-[var(--shadow-elegant)]",
								children: [banner && !bannerError ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("img", {
									src: banner,
									alt: siteName,
									className: "aspect-[4/3] w-full object-cover",
									onError: () => setBannerError(true)
								}), /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-linear-to-t from-background/35 via-transparent to-background/10" })] }) : /* @__PURE__ */ jsx("div", {
									className: "grid aspect-[4/3] w-full place-items-center bg-[image:var(--gradient-brand)] text-primary-foreground",
									children: /* @__PURE__ */ jsx(Boxes, { className: "h-16 w-16 opacity-80" })
			...
			statItems.length > 0 && /* @__PURE__ */ jsx("section", {
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: /* @__PURE__ */ jsx(statIcons[i] ?? Sparkles, { className: "h-5 w-5" })
								}), /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [c.features.title && /* @__PURE__ */ jsx("h2", {
							className: "text-xl font-extrabold sm:text-3xl",
							children: c.features.title
						}), c.features.subtitle && /* @__PURE__ */ jsx("p", {
						...
						children: c.features.items.map((f, i) => {
							...
							return /* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -right-8 -top-8 h-24 w-24 rounded-full bg-primary/20 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" }),
									/* @__PURE__ */ jsxs("div", {
			...
			((c.about?.flow?.length ?? 0) > 0 || c.about?.title || c.about?.body) && /* @__PURE__ */ jsxs("section", {
				id: "about",
				className: "relative overflow-hidden py-14 sm:py-20",
				children: [/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-[image:var(--gradient-brand)] opacity-[0.06]" }), /* @__PURE__ */ jsxs("div", {
					className: "relative mx-auto max-w-6xl px-4 sm:px-6",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "mx-auto max-w-2xl text-center",
							children: [c.about?.title && /* @__PURE__ */ jsx("h2", {
								className: "mt-3 text-xl font-extrabold leading-snug sm:text-3xl",
								children: c.about.title
							}), c.about?.body && /* @__PURE__ */ jsx("p", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute top-10 left-0 right-0 hidden h-1 rounded-full flow-line lg:block" }),
								/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute top-5 bottom-5 left-5 hidden w-1 rounded-full flow-line-vertical lg:hidden" }),
								/* @__PURE__ */ jsx("ol", {
									...
									children: (c.about?.flow ?? []).map((f, i) => {
										...
										return /* @__PURE__ */ jsxs("li", {
											...
											children: [/* @__PURE__ */ jsx("div", {
												...
												children: /* @__PURE__ */ jsx(Icon, { className: "h-5 w-5 lg:h-9 lg:w-9" })
											}), /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						className: "mx-auto max-w-2xl text-center",
						children: [c.how.title && /* @__PURE__ */ jsx("h2", {
							className: "text-xl font-extrabold sm:text-3xl",
							children: c.how.title
						}), c.how.subtitle && /* @__PURE__ */ jsx("p", {
							className: "mt-2 text-sm leading-relaxed text-muted-foreground",
							children: c.how.subtitle
						})]
					}), /* @__PURE__ */ jsx("div", {
						className: "relative mt-10 grid gap-6 md:grid-cols-3",
						children: c.how.steps.map((s, i) => /* @__PURE__ */ jsxs("div", {
			...
			!!stats?.categories?.length && /* @__PURE__ */ jsx("section", {
				id: "categories",
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: (stats?.categories ?? []).map((cat) => /* @__PURE__ */ jsx(CategoryCardItem, { cat }, cat.id))
					})]
				})
			}),
			stats?.products && stats.products.length > 0 && /* @__PURE__ */ jsx("section", {
				id: "products",
				className: "border-y border-border/60 bg-muted/30 py-10 sm:py-14",
				children: /* @__PURE__ */ jsxs("div", {
					className: "mx-auto max-w-7xl px-4 sm:px-6",
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: stats.products.map((p) => /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: p.main_image ? /* @__PURE__ */ jsx("img", {
										src: p.main_image,
										alt: p.name,
										loading: "lazy",
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs(Link, {
								...
								children: [/* @__PURE__ */ jsx(ShoppingBag, { className: "h-4 w-4" }), " View all products"]
							})
						})
					]
				})
			}),
			c.faq && c.faq.items.length > 0 && /* @__PURE__ */ jsx("section", {
				id: "faq",
				className: "border-t border-border/60 bg-muted/30",
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						className: "mx-auto max-w-2xl text-center",
						children: [c.faq.title && /* @__PURE__ */ jsx("h2", {
							className: "text-xl font-extrabold sm:text-3xl",
							children: c.faq.title
						}), c.faq.subtitle && /* @__PURE__ */ jsx("p", {
							className: "mt-2 text-sm leading-relaxed text-muted-foreground",
						...
						children: /* @__PURE__ */ jsx(Accordion, {
							...
							collapsible: true,
							className: "w-full",
							children: c.faq.items.map((item, i) => /* @__PURE__ */ jsxs(AccordionItem, {
								value: `item-${i}`,
								children: [/* @__PURE__ */ jsx(AccordionTrigger, {
									className: "text-sm font-semibold sm:text-base",
									children: /* @__PURE__ */ jsxs("span", {
										className: "flex items-center gap-2 text-left",
										children: [/* @__PURE__ */ jsx(HelpCircle, { className: "h-4 w-4 shrink-0 text-primary" }), item.q]
									})
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -top-24 left-1/2 h-72 w-[36rem] -translate-x-1/2 rounded-full bg-primary-foreground/10 blur-3xl" }),
						/* @__PURE__ */ jsxs("div", {
							className: "relative mx-auto max-w-2xl",
							children: [c.cta.title && /* @__PURE__ */ jsx("h2", {
								className: "text-2xl font-extrabold text-primary-foreground sm:text-3xl",
								children: c.cta.title
							}), c.cta.subtitle && /* @__PURE__ */ jsx("p", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs(Link, {
								...
								children: [/* @__PURE__ */ jsx(Layers, { className: "h-4 w-4" }), " Products"]
							})]
						})
					]
				})
			...
			/* @__PURE__ */ jsxs("footer", {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(PwaFooterOption, {})
					}),
					/* @__PURE__ */ jsxs("div", {
						className: "mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[1.4fr_1fr_1fr]",
						children: [
							/* @__PURE__ */ jsxs("div", { children: [
								...
								/* @__PURE__ */ jsx("div", {
									className: "mt-4",
									children: /* @__PURE__ */ jsx(PwaInstallButton, {
										variant: "footer",
										label: "মোবাইল অ্যাপ ইনস্টল করুন"
									})
								})
							] }),
...
function CategoryCardItem({ cat }) {
	...
	return /* @__PURE__ */ jsxs(Link, {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: cat.image_url && !imgFailed ? /* @__PURE__ */ jsx("img", {
				src: cat.image_url,
				alt: cat.name,
				loading: "lazy",
				className: "h-full w-full object-cover transition-transform duration-500 group-hover:scale-110",

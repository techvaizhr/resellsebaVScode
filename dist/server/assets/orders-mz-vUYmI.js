...
import { t as Route } from "./orders-DwQLv7IC.js";
import { n as PageHeader, t as EmptyState } from "./ui-kit-D-uo76H8.js";
import { p as orderProfit } from "./finance-report-Dwy2dA23.js";
import { i as useDepositSettings, n as fillText, t as DEFAULT_DEPOSIT_TEXTS } from "./deposit-settings-CcRXewTz.js";
...
import { f as syncPathaoStatus, i as courierLabel, n as CourierLogo, p as syncSteadfastStatus } from "./courier-brand-DKAm6Vr-.js";
import { t as NewOrderModal } from "./NewOrderModal-b_gEyZRb.js";
import { t as CopyOrderNumber } from "./CopyOrderNumber-CeUzA8ah.js";
import { a as AdvanceChip, c as recheckCourierStatus, i as ResellerTotalCell, n as OrderEditModal, o as OrderMoneyPanel, s as getOrderDetails, t as CourierTimeline } from "./CourierTimeline-Di8JkPZL.js";
...
import { t as useDepositStatus } from "./deposit-BiZ9ALL3.js";
import { useCallback, useEffect, useMemo, useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { Ban, CheckCircle2, CheckSquare, ChevronDown, Copy, Download, ExternalLink, Eye, FileText, ListChecks, Loader2, MoreVertical, Pencil, Phone, Plus, RefreshCw, Settings2, ShoppingCart, Trash2, TrendingUp, Truck, X } from "lucide-react";
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(ListChecks, { className: "h-4 w-4" }), " Product pick list"]
					}), /* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsx("div", {
					...
					}) : rows.map((p) => /* @__PURE__ */ jsxs("button", {
						type: "button",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("span", { children: [rows.length, " product"] }), /* @__PURE__ */ jsxs("span", {
...
function OrdersPage() {
	...
	const [tab, setTab] = useState(tabParam ?? (qParam ? "all" : "new"));
	...
	const [pickScope, setPickScope] = useState("filtered");
	...
	const markedOrders = useMemo(() => visible.filter((o) => marked.includes(o.id)), [visible, marked]);
	...
	return /* @__PURE__ */ jsxs("div", { children: [
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					activeFilterCount(filters) > 0 && /* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx(X, { className: "h-3.5 w-3.5" }), " Clear filters"]
					})
				]
			})]
		}),
		marked.length > 0 && /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(ListChecks, { className: "h-3.5 w-3.5" }), " Pick list"]
				}),
				/* @__PURE__ */ jsxs("button", {
					type: "button",
					className: "inline-flex h-9 items-center gap-2 rounded-md border bg-background px-3 text-xs font-medium hover:bg-accent",
		...
		pickOpen && /* @__PURE__ */ jsx(PickListModal, {
			rows: pickList,
		...
		loading ? /* @__PURE__ */ jsx("div", {
		...
		}) : paged.length === 0 ? /* @__PURE__ */ jsx(EmptyState, {
			title: "No orders",
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				const actions = /* @__PURE__ */ jsx("div", {
					className: "flex items-center gap-2",
					children: /* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
						...
						children: [
							...
							resellerCanAct(o.status) && /* @__PURE__ */ jsxs(DropdownMenuItem, {
								onClick: () => setEditId(o.id),
								children: [/* @__PURE__ */ jsx(Pencil, { className: "mr-2 h-4 w-4" }), " Edit Order"]
							}),
							(() => {
								if (!shipments.some((s) => (s.order_id === o.id || s.order_id === o.order_number) && (s.consignment_id || s.tracking_id)) && resellerCanAct(o.status) && nextStatuses(o.status, "reseller").length > 0) return /* @__PURE__ */ jsxs(DropdownMenuItem, {
									onClick: () => setStatusModal({
										open: true,
										orderId: o.id,
							...
							/* @__PURE__ */ jsx(DropdownMenuItem, {
								...
								children: /* @__PURE__ */ jsxs(Link, {
									...
									children: [/* @__PURE__ */ jsx(FileText, { className: "mr-2 h-4 w-4" }), " View Invoice"]
								})
							}),
							resellerCanAct(o.status) && !shipments.some((s) => (s.order_id === o.id || s.order_id === o.order_number) && (s.consignment_id || s.tracking_id)) && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(DropdownMenuSeparator, {}), /* @__PURE__ */ jsxs(DropdownMenuItem, {
								onClick: () => remove(o.id),
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										(() => {
											...
											return canChange ? /* @__PURE__ */ jsx("button", {
												type: "button",
												title: "Change status",
												onClick: () => setStatusModal({
													open: true,
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											...
											}), o.status === "forwarded" && o.forwarded_to_admin && /* @__PURE__ */ jsx("span", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											className: "text-[9px] font-semibold uppercase tracking-wider text-muted-foreground/70",
											children: "Courier"
										}), shipments.some((s) => s.order_id === o.id || s.order_id === o.order_number) ? /* @__PURE__ */ jsx("div", {
											...
											children: shipments.filter((s) => s.order_id === o.id || s.order_id === o.order_number).map((s) => /* @__PURE__ */ jsxs("div", {
												...
												children: [
													...
													(() => {
														...
														}) : /* @__PURE__ */ jsx("span", { children: courierLabel(s.provider) });
													})(),
								...
								/* @__PURE__ */ jsx(ResellerTotalCell, { order: withKeptCost(o, itemsByOrder.get(o.id) ?? []) }),
								/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx(OrderProductCell, {
										items: stripItems(o.id),
										expanded: expandedOrders.includes(o.id),
								...
								/* @__PURE__ */ jsx("div", {
									className: "flex justify-center",
									children: /* @__PURE__ */ jsx(ResellerTotalCell, { order: withKeptCost(o, itemsByOrder.get(o.id) ?? []) })
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "min-w-0 text-center",
									children: [
										...
										o.status === "forwarded" && o.forwarded_to_admin && /* @__PURE__ */ jsx("div", {
											className: "mt-0.5 text-[9px] text-success font-medium",
											children: "Sent to admin"
										}),
										orderShipment ? /* @__PURE__ */ jsxs("div", {
											...
											children: [(() => {
												...
												const inner = /* @__PURE__ */ jsxs(Fragment, { children: [
													...
													u && /* @__PURE__ */ jsx(ExternalLink, { className: "h-2.5 w-2.5 shrink-0 opacity-60" })
												] });
												return u ? /* @__PURE__ */ jsx("a", {
													href: u,
													target: "_blank",
													rel: "noopener noreferrer",
													title: "Track on courier website",
												...
												}), orderShipment.consignment_id && /* @__PURE__ */ jsx("button", {
													onClick: () => {
						...
						expandedOrders.includes(o.id) && /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(OrderItemsList, {
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										o.reseller_note && /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
											className: "text-xs font-bold text-muted-foreground uppercase tracking-wider mb-2",
											children: "Your Note"
										}), /* @__PURE__ */ jsx("div", {
		...
		open && resellerId && /* @__PURE__ */ jsx(NewOrderModal, {
			listings,
			allProducts,
			resellerId,
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx("div", {
							...
							children: nextStatuses(statusModal.currentStatus, "reseller").map((s) => /* @__PURE__ */ jsxs("button", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					canAct && /* @__PURE__ */ jsxs("div", {
						...
						children: [
							allowedNext.includes("pending") && /* @__PURE__ */ jsxs("button", {
								disabled: busy,
								...
								children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }), " Move to New Order"]
							}),
							allowedNext.includes("forwarded") && /* @__PURE__ */ jsxs("button", {
								disabled: busy,
								...
								children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }), " Send to admin"]
							}),
							allowedNext.includes("cancelled") && /* @__PURE__ */ jsxs("button", {
								disabled: busy,
								...
								children: [/* @__PURE__ */ jsx(Ban, { className: "h-4 w-4" }), " Cancel Order"]
							})
						]
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("h3", {
								...
								children: [
									...
									order.forwarded_at && /* @__PURE__ */ jsxs("div", {
										className: "flex justify-between items-center text-sm",
										children: [/* @__PURE__ */ jsx("span", {
											className: "text-muted-foreground",
											children: "Sent to Admin"
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("h3", {
								...
								children: [/* @__PURE__ */ jsx(TrendingUp, { className: "h-3.5 w-3.5" }), "Earnings Summary"]
							})
						}), /* @__PURE__ */ jsxs("div", {
					...
					(order.reseller_note || order.notes) && /* @__PURE__ */ jsxs("div", {
						className: "grid grid-cols-1 gap-4 md:grid-cols-2",
						children: [order.notes && /* @__PURE__ */ jsxs("div", {
						...
						}), order.reseller_note && /* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("h3", {
								...
								children: [/* @__PURE__ */ jsx(Truck, { className: "h-3.5 w-3.5" }), "Delivery Information"]
								...
								children: [/* @__PURE__ */ jsx(RefreshCw, { className: `h-3 w-3 ${recheckMutation.isPending ? "animate-spin" : ""}` }), "Check Updates"]
							})]
						}), /* @__PURE__ */ jsx("div", {
							className: "p-4",
							children: shipments.length > 0 ? /* @__PURE__ */ jsxs("div", {
								className: "space-y-6",
								children: [shipments.map((s) => /* @__PURE__ */ jsx("div", {
								...
								children: [
									/* @__PURE__ */ jsx("div", {
										...
										children: /* @__PURE__ */ jsx(Truck, { className: "h-5 w-5 text-muted-foreground/30" })
									}),
									/* @__PURE__ */ jsx("p", {

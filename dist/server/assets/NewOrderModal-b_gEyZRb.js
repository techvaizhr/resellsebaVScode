...
import { Building2, Check, Loader2, Minus, Plus, Search, Trash2, X } from "lucide-react";
...
function SectionLabel({ children }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: "h-4 w-1.5 rounded-full bg-primary" }), /* @__PURE__ */ jsx("span", {
...
function AdvanceByToggle({ value, onChange }) {
	return /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
		...
		children: [["admin", "Admin"], ["reseller", "Reseller"]].map(([v, label]) => /* @__PURE__ */ jsx("button", {
			type: "button",
			onClick: () => onChange(v),
...
function NewOrderModal({ listings, allProducts, resellerId: initialResellerId, resellers = [], onClose, onCreated, isAdmin = false }) {
	const [resellerId, setResellerId] = useState(initialResellerId || null);
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [isAdmin && /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								}), selectedReseller ? /* @__PURE__ */ jsxs("span", {
								...
								children: [
									selectedReseller ? /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx("div", {
												...
												children: selectedReseller.avatar_url ? /* @__PURE__ */ jsx("img", {
												...
												children: [/* @__PURE__ */ jsxs("div", {
													...
													children: [
														...
														selectedReseller.status && /* @__PURE__ */ jsx("span", {
											...
											children: /* @__PURE__ */ jsxs("button", {
												...
												children: [/* @__PURE__ */ jsx(X, { className: "h-3 w-3" }), /* @__PURE__ */ jsx("span", { children: "Remove" })]
											})
										})]
									}) : /* @__PURE__ */ jsxs("div", {
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											resellerSearch && /* @__PURE__ */ jsx("button", {
												type: "button",
									...
									resellerSearch && /* @__PURE__ */ jsx("div", {
											...
											return /* @__PURE__ */ jsxs("button", {
												...
												children: [/* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsx("div", {
														...
														}), r.contact_phone && /* @__PURE__ */ jsx("p", {
													...
													children: [/* @__PURE__ */ jsx(Check, { className: "h-3 w-3" }), " Selected"]
												}) : /* @__PURE__ */ jsx("span", {
							...
							children: [
									...
									children: [/* @__PURE__ */ jsx("label", {
										...
										children: [
											/* @__PURE__ */ jsxs(Field, {
												...
												}), name && errors.name && /* @__PURE__ */ jsx(FieldError, { text: errors.name })]
											}),
											/* @__PURE__ */ jsxs(Field, {
												label: "Mobile Number",
												children: [/* @__PURE__ */ jsx("input", {
													...
													className: "w-full rounded-lg border px-3 py-2 text-[13px] focus:ring-2 focus:ring-primary/20"
												}), phone && errors.phone && /* @__PURE__ */ jsx(FieldError, { text: errors.phone })]
											}),
											/* @__PURE__ */ jsxs(Field, {
												...
												}), address && errors.address && /* @__PURE__ */ jsx(FieldError, { text: errors.address })]
											})
										]
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										}), picked.length > 0 && /* @__PURE__ */ jsxs("span", {
										...
										children: [
											/* @__PURE__ */ jsx("div", {
												...
												children: /* @__PURE__ */ jsxs("div", {
													className: "relative",
													children: [/* @__PURE__ */ jsx(Search, { className: "pointer-events-none absolute left-3 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-muted-foreground/60" }), /* @__PURE__ */ jsx("input", {
														value: query,
											...
											(query.trim() !== "" || picked.length === 0 || showPicker) && /* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsxs("div", {
													...
													}), picked.length > 0 && /* @__PURE__ */ jsx("button", {
														type: "button",
														onClick: () => {
															setShowPicker(false);
															setQuery("");
													...
													return /* @__PURE__ */ jsxs("button", {
														...
														children: [
															/* @__PURE__ */ jsx("div", {
																...
																}) : /* @__PURE__ */ jsx(Search, { className: "m-auto h-full w-1/2 text-muted-foreground/30" })
															}),
															/* @__PURE__ */ jsxs("div", {
																...
																children: [/* @__PURE__ */ jsxs("div", {
																	...
																	children: [/* @__PURE__ */ jsx("span", {
																		...
																		children: p.name
																	}), item.type === "listing" && /* @__PURE__ */ jsx("span", {
																	...
																	children: [
																		/* @__PURE__ */ jsx(ProductCodeChip, { code: p.product_code }),
																		/* @__PURE__ */ jsxs("span", {
															...
															/* @__PURE__ */ jsxs("div", {
																...
																children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: inCart ? "Added" : "Add" })]
															})
														]
											...
											picked.length > 0 && !query && !showPicker && /* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsxs("span", {
													...
													children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5" }), "Browse / Add more"]
												})]
											}),
											/* @__PURE__ */ jsx("div", {
												className: "flex-1 max-h-[300px] overflow-y-auto divide-y bg-background",
												children: picked.length === 0 ? /* @__PURE__ */ jsxs("div", {
												...
												}) : picked.map(({ line, p, sellPrice, minPrice, listingId }, i) => /* @__PURE__ */ jsxs("div", {
													...
													children: [
														...
														/* @__PURE__ */ jsxs("div", {
															...
															children: [
																...
																/* @__PURE__ */ jsx("div", {
																	className: "mt-1",
																	children: /* @__PURE__ */ jsx(ProductCodeChip, { code: p.product_code })
																}),
																/* @__PURE__ */ jsxs("div", {
											...
											totals.showAreaPicker && /* @__PURE__ */ jsxs("div", {
								...
								picked.length > 0 && /* @__PURE__ */ jsxs("div", {
									className: "space-y-3",
									children: [
						...
						children: [
							...
							/* @__PURE__ */ jsx(SectionLabel, { children: "Order Summary" }),
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
											...
											children: [
												...
												/* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsxs("div", {
														...
														}), picked.length > 1 && /* @__PURE__ */ jsx("span", {
												...
												totals.discount > 0 && /* @__PURE__ */ jsxs("div", {
												...
												totals.advance > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", {
													className: "flex justify-between text-xs",
													children: [/* @__PURE__ */ jsxs("span", {
														className: "font-medium text-muted-foreground",
														children: ["Advance received", /* @__PURE__ */ jsx("span", {
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												totals.resellerAdvance > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", {
													className: "flex justify-between text-xs text-muted-foreground",
													children: [/* @__PURE__ */ jsx("span", {
														className: "font-medium",
									...
									children: busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-5 w-5 animate-spin" }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("span", { children: "Place Order" }), /* @__PURE__ */ jsx(Plus, { className: "h-4 w-4 group-hover:rotate-90 transition-transform" })] })
								})]
							})
						]
					})]

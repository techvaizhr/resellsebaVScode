...
import { a as moveMenuItem, c as shiftMenuItem, l as subtreeSize, n as fetchMenuRows, o as newMenuItem, r as flattenMenu, s as saveMenuRows, t as buildMenuTree } from "./store-menu-K9arh0xV.js";
import { useEffect, useMemo, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { ChevronDown, ChevronRight, ChevronsLeft, ChevronsRight, GripVertical, Home, Layers, Link2, Loader2, Package, Plus, Save, Search, Trash2 } from "lucide-react";
...
function MenusPage() {
	...
	if (!rid) return /* @__PURE__ */ jsx("div", {
		...
		/* @__PURE__ */ jsx(PageHeader, {
			...
			actions: /* @__PURE__ */ jsxs("div", {
				...
				children: [code && /* @__PURE__ */ jsx("a", {
					...
					children: [busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Save, { className: "h-4 w-4" }), "Save menu"]
				})]
			})
		}),
		/* @__PURE__ */ jsxs("div", {
					...
					tab === "custom" ? /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(Plus, { className: "h-4 w-4" }), " Add custom link"]
							}),
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: [/* @__PURE__ */ jsxs("button", {
										...
										className: "inline-flex items-center gap-1.5 rounded-md border px-3 py-1.5 text-xs font-medium hover:bg-muted",
										children: [/* @__PURE__ */ jsx(Package, { className: "h-3.5 w-3.5" }), " All products"]
									})]
								})]
							})
						]
						...
						/* @__PURE__ */ jsxs("div", {
							...
							}), filtered.map((s) => /* @__PURE__ */ jsxs("label", {
						...
						/* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(Plus, { className: "h-4 w-4" }), " Add to menu"]
						})
					] })
				]
			}), /* @__PURE__ */ jsxs("div", {
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("button", {
										...
										children: [
											...
											item.depth === 0 && item.layout === "mega" && /* @__PURE__ */ jsx("span", {
												className: "shrink-0 rounded-full bg-primary/15 px-2 py-0.5 text-[10px] font-semibold text-primary",
												children: "Mega"
											}),
											open ? /* @__PURE__ */ jsx(ChevronDown, { className: "ml-auto h-4 w-4 shrink-0" }) : /* @__PURE__ */ jsx(ChevronRight, { className: "ml-auto h-4 w-4 shrink-0" })
										]
									}),
									/* @__PURE__ */ jsx("button", {
								...
								children: [
									...
									}), item.kind === "custom" ? /* @__PURE__ */ jsx("input", {
										className: inp,
										value: item.url ?? "",
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											item.depth === 0 && /* @__PURE__ */ jsxs("label", {
												className: "inline-flex items-center gap-2 text-sm",
												children: [/* @__PURE__ */ jsx("input", {
													type: "checkbox",

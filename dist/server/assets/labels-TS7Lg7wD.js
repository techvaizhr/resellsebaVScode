...
import { r as supabase, s as createSsrRpc } from "./client-CdRSQB5v.js";
import { t as useServerFn } from "./useServerFn-CrZF2pjq.js";
import { t as requireSupabaseAuth } from "./auth-middleware-BK7ADgER.js";
import { n as Dialog, o as DialogHeader, r as DialogContent, s as DialogTitle } from "./ConfirmModal-CPm0pZdA.js";
import { n as getGlobalSettings } from "./app-data-tJP6g7R4.js";
import { c as bookSteadfast, n as CourierLogo, o as bookCarrybee, r as courierBrand, s as bookPathao, t as COURIER_BRANDS } from "./courier-brand-DKAm6Vr-.js";
import { useEffect, useMemo, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { useQuery } from "@tanstack/react-query";
import { toast } from "sonner";
import { AlertTriangle, Loader2, Store, Truck } from "lucide-react";
...
function ShipmentBookingModal({ isOpen, onClose, orderIds, onSuccess }) {
	...
	const activeCourierList = useMemo(() => activeProviders.map((id) => COURIER_BRANDS[id]).filter(Boolean), [activeProviders]);
	const current = useMemo(() => options.find((o) => o.provider === provider) ?? null, [options, provider]);
	...
	if (autoBook && isOpen) return /* @__PURE__ */ jsx(Dialog, {
		open: isOpen,
		...
		children: /* @__PURE__ */ jsx(DialogContent, {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Loader2, { className: "h-8 w-8 animate-spin text-primary mb-4" }), /* @__PURE__ */ jsxs("p", {
		...
		children: /* @__PURE__ */ jsxs(DialogContent, {
			...
			children: [
				/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsxs(DialogTitle, {
					...
					children: [/* @__PURE__ */ jsx(Truck, { className: "h-5 w-5 text-primary" }), "Courier Booking"]
				}) }),
				/* @__PURE__ */ jsxs("div", {
					className: "py-4",
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: activeCourierList.map((p) => /* @__PURE__ */ jsxs("button", {
								...
								}), provider === p.id && /* @__PURE__ */ jsx("div", { className: "h-2 w-2 rounded-full bg-primary" })]
							}, p.id))
						}),
						stores.length > 0 && /* @__PURE__ */ jsxs("div", {
							className: "mt-4",
							children: [/* @__PURE__ */ jsxs("label", {
								...
								children: [
									...
									" Pickup store",
									stores.length > 1 && /* @__PURE__ */ jsxs("span", {
								...
								children: stores.map((s) => /* @__PURE__ */ jsxs("option", {
									value: s.id,
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "h-5 w-5 shrink-0" }), /* @__PURE__ */ jsx("p", {

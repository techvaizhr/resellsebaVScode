...
function StatCard({ label, value, hint, icon, trend, tone = "primary", to, search }) {
	const t = TONES[tone];
	return /* @__PURE__ */ jsxs(to ? Link : "div", {
		...to ? {
			to,
			search
		} : {},
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: cn("pointer-events-none absolute inset-0 rounded-[inherit] bg-gradient-to-r to-transparent opacity-0 transition-opacity group-hover:opacity-100", t.glow) }),
			/* @__PURE__ */ jsxs("div", {

...
import { t as Route } from "./orders-sW-CH05a.js";
...
import { c as filterByCourier, i as DEFAULT_ORDER_FILTERS, n as COURIER_FILTER_OPTIONS, o as activeFilterCount, r as DATE_PRESET_OPTIONS, s as applyOrderFilters, t as AREA_FILTER_OPTIONS } from "./order-filters-C0seZ87w.js";
...
import { a as autoSyncCourierStatuses, f as syncPathaoStatus, i as courierLabel, n as CourierLogo, p as syncSteadfastStatus, t as COURIER_BRANDS } from "./courier-brand-DKAm6Vr-.js";
import { r as getAdminLookups } from "./bootstrap-mAz5ZP06.js";
import { t as NewOrderModal } from "./NewOrderModal-b_gEyZRb.js";
import { t as BulkScanButton } from "./BulkScanModal-Fmfkwu6s.js";
import { t as CopyOrderNumber } from "./CopyOrderNumber-CeUzA8ah.js";
import { a as getActiveCouriers, i as orderSupplierTint, n as printShippingLabels, r as ShipmentBookingModal } from "./labels-TS7Lg7wD.js";
import { a as AdvanceChip, c as recheckCourierStatus, i as ResellerTotalCell, n as OrderEditModal, o as OrderMoneyPanel, r as AdminTotalCell, s as getOrderDetails, t as CourierTimeline } from "./CourierTimeline-Di8JkPZL.js";
import { a as OrderNotePreview, c as OrderNotes, d as OrderProductCell, i as LastUpdateCell, l as ImageLightbox, n as courierTrackingUrl, o as OrderNotesModal, r as OrderTabs, s as useOrderMeta, t as OrderSearch, u as OrderItemsList } from "./order-search-Dnzvl01g.js";
import { n as CalcPanel, r as CalcRow } from "./price-breakdown-CGuNUtD0.js";
import { useCallback, useEffect, useMemo, useRef, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { CheckCircle2, CheckSquare, ChevronDown, Copy, DollarSign, ExternalLink, Eye, Loader2, MoreVertical, Pencil, Phone, Plus, Printer, RefreshCw, Settings2, ShoppingCart, Trash2, TrendingUp, Truck, UserCircle, X } from "lucide-react";
...
function AdminOrdersPage() {
	...
	const [allProducts, setAllProducts] = useState(initial_data_default.products || []);
	...
	const stripItems = useCallback((orderId) => (itemsByOrder.get(orderId) ?? []).map((it, idx) => {
	...
	*/
	const buyingCostFor = useCallback((orderId, status) => {
		let cost = 0;
	...
	const moneyOrder = useCallback((o) => withKeptCost(o, itemsByOrder.get(o.id) ?? []), [itemsByOrder]);
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsx(PageHeader, {
			...
			actions: /* @__PURE__ */ jsxs("div", {
				...
				children: [!isPartialStatus(tab) && canStatus && /* @__PURE__ */ jsx(BulkScanButton, {
					...
					children: [/* @__PURE__ */ jsx(Plus, { className: "h-4 w-4" }), " New Order"]
				})]
			})
		}),
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				className: "flex items-center gap-2",
				children: [/* @__PURE__ */ jsx(OrderSearch, {
					mode: searchMode,
				...
				children: [
					...
					/* @__PURE__ */ jsx("select", {
						...
						title: "Delivery area",
						children: AREA_FILTER_OPTIONS.map((o) => /* @__PURE__ */ jsx("option", {
							value: o.value,
							children: o.label
						}, o.value))
					}),
					/* @__PURE__ */ jsx("select", {
						...
						className: "h-10 w-full rounded-md border bg-background px-2 text-xs font-medium outline-none focus:ring-1 focus:ring-primary lg:w-[150px]",
						title: "Courier",
						children: COURIER_FILTER_OPTIONS.map((o) => /* @__PURE__ */ jsx("option", {
							value: o.value,
							children: o.label
						}, o.value))
					}),
					...
					/* @__PURE__ */ jsx("div", {
						className: "sm:hidden",
						children: /* @__PURE__ */ jsx(OrderTabs, {
							tab,
							onChange: setTab,
							highlight: true,
							count: (key) => {
					...
					activeFilterCount(filters) > 0 && /* @__PURE__ */ jsxs("button", {
						type: "button",
						onClick: () => setFilters({
							...DEFAULT_ORDER_FILTERS,
		...
		filters.datePreset === "custom" && /* @__PURE__ */ jsxs("div", {
		...
		canBulkAny && marked.length > 0 && /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(CheckSquare, { className: "h-3.5 w-3.5" }), marked.length === paged.length ? "Unselect all" : "Select all"]
				}),
				canStatus && (() => {
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx(Settings2, { className: "h-3.5 w-3.5" }), " Change Status"]
					});
				})(),
				canShip && /* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(Printer, { className: "h-3.5 w-3.5" }), " Print Labels"]
				}),
				canShip && /* @__PURE__ */ jsxs("button", {
		...
		loading ? /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx(Loader2, { className: "mx-auto h-6 w-6 animate-spin" })
		}) : /* @__PURE__ */ jsxs("div", {
			className: "space-y-3",
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: canBulkAny && /* @__PURE__ */ jsx("input", {
							type: "checkbox",
					...
					children: [
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											className: "min-w-0 flex-1",
											children: [/* @__PURE__ */ jsx(CopyOrderNumber, {
										...
										canOpenStatusFor(o) ? /* @__PURE__ */ jsx("button", {
											type: "button",
											title: "Change status",
										...
										/* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
											...
											children: [
												...
												canEdit && /* @__PURE__ */ jsxs(DropdownMenuItem, {
													onClick: () => setEditId(o.id),
													children: [/* @__PURE__ */ jsx(Pencil, { className: "mr-2 h-4 w-4" }), " Edit Order"]
												}),
												canOpenStatusFor(o) && /* @__PURE__ */ jsxs(DropdownMenuItem, {
													onClick: () => openStatusOrSettle(o),
													children: [/* @__PURE__ */ jsx(Settings2, { className: "mr-2 h-4 w-4" }), " Change Status"]
												}),
												canShip && !shipments.some((s) => (s.order_id === o.id || s.order_id === o.order_number) && (s.consignment_id || s.tracking_id)) && /* @__PURE__ */ jsxs(DropdownMenuItem, {
													onClick: () => setBookingModal({
														open: true,
														orderIds: [o.id]
													}),
												...
												canDelete && /* @__PURE__ */ jsxs(DropdownMenuItem, {
													onClick: () => removeOrder(o.id),
													className: "text-destructive focus:bg-destructive/10 focus:text-destructive",
													children: [/* @__PURE__ */ jsx(Trash2, { className: "mr-2 h-4 w-4" }), " Delete Order"]
												})
											]
										})] }),
										/* @__PURE__ */ jsx("button", {
											...
											children: /* @__PURE__ */ jsx(ChevronDown, { className: `h-4 w-4 transition-transform ${expandedOrders.includes(o.id) ? "rotate-180" : ""}` })
										})
									]
								}),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											o.resellers?.contact_phone && /* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsx("span", {
													...
													className: "shrink-0 text-primary hover:text-primary/80",
													children: /* @__PURE__ */ jsx(Phone, { className: "h-3 w-3" })
												})]
											}),
											/* @__PURE__ */ jsxs("div", {
												className: "flex min-w-0 items-center gap-1 text-[11px] text-muted-foreground",
												children: [/* @__PURE__ */ jsx(UserCircle, { className: "h-3 w-3 shrink-0" }), /* @__PURE__ */ jsx("span", {
													className: "truncate",
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											className: "text-[9px] font-semibold uppercase tracking-wider text-muted-foreground/70",
											children: "Courier"
										}), shipments.filter((s) => s.order_id === o.id || s.order_id === o.order_number).length > 0 ? /* @__PURE__ */ jsx("div", {
												...
												return /* @__PURE__ */ jsxs("div", {
													...
													children: [
														...
														url ? /* @__PURE__ */ jsxs("a", {
															...
															children: [courierLabel(s.provider), /* @__PURE__ */ jsx(ExternalLink, { className: "h-2 w-2" })]
														}) : /* @__PURE__ */ jsx("span", {
															className: "font-bold text-primary",
															children: courierLabel(s.provider)
														}),
														s.consignment_id && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("span", {
								...
								/* @__PURE__ */ jsxs("div", {
									className: "grid grid-cols-2 gap-2",
									children: [/* @__PURE__ */ jsx(ResellerTotalCell, { order: moneyOrder(o) }), /* @__PURE__ */ jsx(AdminTotalCell, {
										order: moneyOrder(o),
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
									...
									children: [
										...
										/* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
											...
											children: [
												...
												canShip && (() => {
													if (!shipments.some((s) => (s.order_id === o.id || s.order_id === o.order_number) && (s.consignment_id || s.tracking_id))) return /* @__PURE__ */ jsxs(DropdownMenuItem, {
														onClick: () => setBookingModal({
															open: true,
															orderIds: [o.id]
														}),
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [o.resellers?.contact_phone || "—", o.resellers?.contact_phone && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("a", {
												href: `tel:${o.resellers.contact_phone}`,
										...
										/* @__PURE__ */ jsx("div", {
											...
											children: o.resellers?.agents?.display_name ? /* @__PURE__ */ jsxs("span", {
												className: "inline-flex items-center gap-1",
												children: [/* @__PURE__ */ jsx(UserCircle, { className: "h-2.5 w-2.5" }), o.resellers.agents.display_name]
											}) : /* @__PURE__ */ jsx("span", {
												className: "italic",
												children: "no agent"
											})
								...
								/* @__PURE__ */ jsx("div", {
									className: "flex justify-center",
									children: /* @__PURE__ */ jsx(ResellerTotalCell, { order: moneyOrder(o) })
								}),
								/* @__PURE__ */ jsx("div", {
									className: "flex justify-center",
									children: /* @__PURE__ */ jsx(AdminTotalCell, {
										order: moneyOrder(o),
										buyingCost: buyingCostFor(o.id, o.status)
									})
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "min-w-0 text-center",
									children: [canOpenStatusFor(o) ? /* @__PURE__ */ jsx("button", {
										type: "button",
										title: "Change status",
										onClick: () => openStatusOrSettle(o),
										...
										children: shipments.filter((s) => s.order_id === o.id || s.order_id === o.order_number).map((s) => /* @__PURE__ */ jsxs("div", {
											...
											children: [(() => {
												...
												const inner = /* @__PURE__ */ jsxs(Fragment, { children: [
													...
													url && /* @__PURE__ */ jsx(ExternalLink, { className: "h-2.5 w-2.5 shrink-0 opacity-60" })
												] });
												...
												}), s.consignment_id && /* @__PURE__ */ jsx("button", {
													onClick: () => {
														navigator.clipboard.writeText(s.consignment_id);
														toast.success("Booking ID copied");
													},
						...
						expandedOrders.includes(o.id) && /* @__PURE__ */ jsx("div", {
							className: "bg-muted/30 px-4 py-5 md:px-8",
							children: /* @__PURE__ */ jsxs("div", {
								className: "grid grid-cols-1 gap-6 md:grid-cols-2",
								children: [/* @__PURE__ */ jsx(OrderItemsList, {
									items: stripItems(o.id),
									onZoom: setZoomImage
								}), /* @__PURE__ */ jsxs("div", {
									className: "space-y-4",
									children: [
										...
										o.admin_note && /* @__PURE__ */ jsxs("div", {
										...
										o.reseller_note && /* @__PURE__ */ jsxs("div", {
		...
		statusModal && statusModal.open && /* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx("div", {
							...
							children: (() => {
								...
								children: [
									/* @__PURE__ */ jsx("div", { className: `h-2.5 w-2.5 rounded-full ring-2 ring-offset-2 ring-offset-background ${orderStatusTone(s).split(" ")[0]} ${statusModal.currentStatus === s ? "ring-primary/40" : "ring-transparent group-hover:ring-accent-foreground/10"}` }),
									/* @__PURE__ */ jsx("span", {
									...
									statusModal.currentStatus === s && /* @__PURE__ */ jsx(CheckCircle2, { className: "h-3.5 w-3.5 text-primary" })
								]
							}, s))
						})
					}),
		...
		/* @__PURE__ */ jsx(ShipmentBookingModal, {
		...
		open && /* @__PURE__ */ jsx(NewOrderModal, {
			listings: [],
			allProducts,
			resellers,
			isAdmin: true,
		...
		editId && /* @__PURE__ */ jsx(OrderEditModal, {
			orderId: editId,
			allProducts,
			isAdmin: true,
		...
		selected && /* @__PURE__ */ jsx(OrderDrawer, {
			orderId: selected.id,
			onClose: () => setSelected(null),
			allProducts
		}),
		zoomImage && /* @__PURE__ */ jsx(ImageLightbox, {
			src: zoomImage,
			onClose: () => setZoomImage(null)
		}),
		notesModal && /* @__PURE__ */ jsx(OrderNotesModal, {
...
function OrderDrawer({ orderId, onClose, allProducts }) {
	...
	if (!data?.order) return /* @__PURE__ */ jsx("div", {
		className: "fixed inset-0 z-50 flex justify-end bg-black/50 backdrop-blur-sm",
		onClick: onClose,
		children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("h3", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(Phone, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("span", {
											className: "font-medium",
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(Truck, { className: "h-4 w-4 text-primary mt-1 shrink-0" }), /* @__PURE__ */ jsxs("p", {
							...
							children: [/* @__PURE__ */ jsx("h3", {
							...
							}), order.resellers ? /* @__PURE__ */ jsxs("div", {
								className: "space-y-2 text-sm",
								children: [
									/* @__PURE__ */ jsx("p", {
									...
									/* @__PURE__ */ jsxs("div", {
										className: "flex items-center gap-2 text-muted-foreground",
										children: [/* @__PURE__ */ jsx(Phone, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("span", { children: order.resellers.contact_phone || "—" })]
									}),
									/* @__PURE__ */ jsxs("div", {
										className: "flex items-center gap-1.5 text-xs text-muted-foreground",
										children: [/* @__PURE__ */ jsx(UserCircle, { className: "h-3.5 w-3.5 text-primary" }), /* @__PURE__ */ jsx("span", {
											className: "font-medium",
											children: order.resellers.agents?.display_name || /* @__PURE__ */ jsx("span", {
								...
								children: [/* @__PURE__ */ jsx(TrendingUp, { className: "h-5 w-5" }), /* @__PURE__ */ jsx("span", {
									className: "font-bold",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("h3", {
								...
								children: [/* @__PURE__ */ jsx(DollarSign, { className: "h-3.5 w-3.5" }), "Financial Breakdown"]
							})
						}), /* @__PURE__ */ jsxs("div", {
							className: "space-y-3 p-4",
							children: [/* @__PURE__ */ jsxs("div", {
								className: "flex flex-wrap items-center gap-2",
								children: [/* @__PURE__ */ jsx(AdvanceChip, { order }), /* @__PURE__ */ jsxs("span", {
									...
									children: [
										/* @__PURE__ */ jsx("div", {
											...
											children: p?.og_image_url ? /* @__PURE__ */ jsx("img", {
												...
												children: /* @__PURE__ */ jsx(ShoppingCart, { className: "h-6 w-6 text-muted-foreground/40" })
											})
										}),
										/* @__PURE__ */ jsxs("div", {
											className: "min-w-0 flex-1",
					...
					(order.reseller_note || order.admin_note) && /* @__PURE__ */ jsxs("div", {
						className: "grid grid-cols-1 gap-4 md:grid-cols-2",
						children: [order.reseller_note && /* @__PURE__ */ jsxs("div", {
						...
						}), order.admin_note && /* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("h3", {
								...
								children: [/* @__PURE__ */ jsx(Truck, { className: "h-3.5 w-3.5" }), "Courier Logistics"]
							}), shipments.length > 0 && /* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(RefreshCw, { className: `h-3 w-3 ${recheckMutation.isPending ? "animate-spin" : ""}` }), "Recheck Status"]
							})]
						}), /* @__PURE__ */ jsx("div", {
							className: "p-4",
							children: shipments.length > 0 ? /* @__PURE__ */ jsxs("div", {
								className: "space-y-6",
								children: [shipments.map((s) => /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx("span", {
												...
												children: ["Courier: ", /* @__PURE__ */ jsx("span", {
									...
									}), /* @__PURE__ */ jsx(CourierTimeline, { events })]
								})]
							}) : /* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx("div", {
										...
										children: /* @__PURE__ */ jsx(Truck, { className: "h-6 w-6 text-muted-foreground/30" })
									}),
									/* @__PURE__ */ jsx("p", {
